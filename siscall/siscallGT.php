...
$obj = new connessioneGt();
$conn = $obj->apriConnessioneGt();
...
$queryRicerca = "SELECT v.user AS USER, "
...
if (!$risultato) {
    ...
    $queryTruncate = "TRUNCATE TABLE `stringheSiscallGT`";
    ...
    while ($riga = $risultato->fetch_array()) {
        ...
        $queryInserimento = "INSERT INTO `stringheSiscallGT`"
