...
$obj = new connessioneDigital();
$conn = $obj->apriConnessioneDigital();
...
if (!$risultato) {
    ...
    $queryTruncate = "TRUNCATE TABLE `stringheSiscallDigital`";
    ...
    while ($riga = $risultato->fetch_array()) {
        ...
        $queryInserimento = "INSERT INTO `stringheSiscallDigital`"
