...
$query = "select "
        ...
        . "round(irenPesoLordo,2) as 'iren Peso Lordo',"
        . "round(irenPesoPagato,2) as 'iren Peso Pagato',"
        . "round(irenPesoFormazione,2) as 'iren Peso Formazione', "
        . "round(unionPesoLordo,2) as 'union Peso Lordo',"
        . "round(unionPesoPagato,2) as 'union Peso Pagato',"
        . "round(unionPesoFormazione,2) as 'union Peso Formazione',"
        . "round(enelPesoLordo,2) as 'enel Peso Lordo',"
        . "round(enelPesoPagato,2) as 'enel Peso Pagato',"
        . "round(enelPesoFormazione,2) as 'enel Peso Formazione' "
        . "from pagamentoMese "
...
while ($lista = $risultato->fetch_array()) {
    ...
    $intestazioneChiamate .= ";";
    $intestazioneChiamate .= str_replace(".", ",", $lista[21]);
    $intestazioneChiamate .= ";";
    $intestazioneChiamate .= str_replace(".", ",", $lista[22]);
    $intestazioneChiamate .= ";";
    $intestazioneChiamate .= str_replace(".", ",", $lista[23]);
    $intestazioneChiamate .= ";";
    $intestazioneChiamate .= str_replace(".", ",", $lista[24]);
    $intestazioneChiamate .= ";";
