...
<html>
    ...
    <body style="font-family: poppins;" onload="permessi(),aggiornaSedePlenitude()">
        <header>
            <h1>Metrics: Cruscotto KPI Quartili</h1>
        </header>
                ...
                <div style="display: flex;flex-wrap: nowrap;align-content: flex-start;justify-content: space-around;align-items: center;">
                    ...
                    <div style="display: flex;align-content: space-between;align-items: center;justify-content: space-around;flex-direction: column;flex-wrap: nowrap;">
                        <label for="dataInizio">Data Inizio:
                            <input type="date" id="dataInizio" name="dataInizio" max="<?= $dataMassima ?>"  min="<?= $dataMinima ?>" value="<?= $dataDefault ?>"  onchange="aggiornaSedePlenitude();" > 
                        </label>
                        <br>
                        <label for="dataFine">Data  Fine: 
                            <input type="date" id="dataFine" name="datafine" max="<?= $dataMassima ?>"  min="<?= $dataMinima ?>" value="<?= $dataDefault ?>" onchange="aggiornaSedePlenitude();">
                        </label>
                    </div>
                    ...
                    <div style="display: flex;align-content: center;align-items: center;justify-content: space-evenly;">
                        ...
                        <select  size="4" multiple id="sede" onchange="filtroEnergyKpiNuova();creaTabellaQuartili()" >
                        </select>   
                    </div>
                    
                    <div style="display: flex;align-content: center;align-items: center;justify-content: space-evenly;">                                         
                        <button type="button" onclick="creaTabellaLeadKpiPlenitude();creaTabellaQuartili();pdpEsternoVuoto();resetKpi()">Aggiorna KPI</button>           
                    </div>
...
<div>
    <a id="quartili" style="display:flex;flex-wrap: nowrap;align-items: flex-start;flex-direction: column;align-content: center;justify-content: space-between;"></a>
</div>
<br>
<div >
    <a id="kpi" style="display:flex;flex-wrap: nowrap;align-items: flex-start;flex-direction: column;align-content: center;justify-content: space-between;"></a>
</div>
<br>
<div >
...
<script>
<?php
include "/Applications/MAMP/htdocs/Know/cruscotto/js/funzioniCruscottopv.js";
?>
</script>
</html>
