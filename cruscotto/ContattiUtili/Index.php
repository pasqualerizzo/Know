...
<html>
    <head>
        <title>Metrics: Contatti Utili Heracom</title>
    ...
    <body style="font-family: poppins;" onload="aggiornaMandatoMese();">
        <header>
            <h1>Metrics: Contatti Utili Heracom</h1>
        </header>
...
<!--                    <div style="display: flex; width: 25%; align-content: center; align-items: center; justify-content: space-evenly;">
                    ...
                    <div style="display: flex; flex-direction: column;">
                       ...
                       <button type="button" onclick="creaTabellaCU(); creaTabellaContattiUtili()">Aggiorna</button>                       
...
<!--                    <div style="display: flex; flex-direction: column;">
        ...
        <div>
            <a id="ContattiUtili" style="display: flex; flex-wrap: nowrap; align-items: flex-start; flex-direction: column; align-content: center; justify-content: space-between;"></a>
        </div>
        <br>
<!--        <div>
