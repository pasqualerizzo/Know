...
<html>
    <head>
        <title>Metrics: Ore Dichiarate</title>
...
<!--                    <div style="display: flex; width: 25%; align-content: center; align-items: center; justify-content: space-evenly;">
                    ...
                    <div style="display: flex; flex-direction: column;">
                       ...
                       <button type="button" onclick="creaTabellaOreDichiarate(); creaTabellaOreDichiarateMensile()">Aggiorna</button>                       
                                                
                    </div>
<!--                    
                       <div style="display: flex; flex-direction: column;">
                        
                       <button type="button" onclick="creaTabellaAvanzamentoMesi() "></button>                       
...
<!--                    <div style="display: flex; flex-direction: column;">
        ...
        <div>
            <a id="oreDichiarate" style="display: flex; flex-wrap: nowrap; align-items: flex-start; flex-direction: column; align-content: center; justify-content: space-between;"></a>
        </div>
        <br>
<!--        <div>
            <a id= "Cu" style="display: flex; flex-wrap: nowrap; align-items: flex-start; flex-direction: row; align-content: center; justify-content: space-between;"></a>
        </div>
        <br>-->

    </body>
    <script>
        <?php include "/Applications/MAMP/htdocs/Know/cruscotto/js/funzioniCruscottopv.js"; ?>
    </script>
</html>
