...
<html>
    ...
    <body style="font-family: poppins;" onload="aggiornaMandatoInvertito();permessi()">
        <header>
            <h1>Metrics:Cruscotto Produzione SUB UNO</h1>
        </header>
    ...
    <div style="display: flex;flex-direction: column;">
        <button type="button" onclick="CATANZARO ESSE">CATANZARO ESSE</button>
        <select size="1" id="sede" multiple disabled>
            <option value="CATANZARO ESSE" selected>CATANZARO ESSE</option>
        </select>
    </div>
                    ...
                    <div style="display: flex;flex-direction: column;">
                        ...
                        <button type="button" onclick="creaTabellaInvertitoSubUno();creaTabellaPdpSubUno();creaTabellaPdpEsternoSubUno();creaTabellaMatricolaSubUno()">Aggiorna</button>
