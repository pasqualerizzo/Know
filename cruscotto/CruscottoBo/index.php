...
<html>
    <head>
        <title>Metrics: Cruscotto Backoffice</title>
    ...
    <body style="font-family: poppins;" onload="aggiornaSedeData();permessi()">
         </header>
...
<!--                    <div style="display: flex;width: 25%;align-content: center;align-items: center;justify-content: space-evenly;">
                    ...
                    <div style="display: flex;flex-direction: column;">
                        ...
                        <button type="button" onclick="creaTabellaCruscottoBo()">Aggiorna</button>
<!--                        <button type="button" onclick="creaTabellaInvertitoEsteso();creaTabellaPdp();creaTabellaPdpEsterno();creaTabellaMatricola()">Esteso</button>                            
                        <button type="button" onclick="creaTabellaGiornaliero();creaTabellaPdpGiornaliero();pdpEsternoVuoto()">Cruscotto Lead</button>                        -->
                    </div>
                </div>
            </form>
        </div>
