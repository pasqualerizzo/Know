...
$queryGroupMandato = "SELECT sede FROM `stringheTotale` where giorno>='$dataMinore' and giorno<='$dataMaggiore' and mandato='Lead Inbound' and livello<8 group by sede";
