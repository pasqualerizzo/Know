...
$queryGroupMandato = "SELECT idMandato FROM `stringheTotale` where giorno>='$dataMinore' and giorno<='$dataMaggiore' and livello=1 and idMandato<>'vodafone' and idMandato<>'' group by idMandato";
