...
include "/Applications/MAMP/htdocs/Know/cruscotto/js/funzioniCruscottopv.php";
...
<html>
    <head>
        <title>Metrics: Cruscotto Digitale Assenze</title>
    ...
    <body style="font-family: poppins;" onload="aggiornaSedeData();permessi();aggiornaMandato()">
        <header>
            <h1>Metrics: Cruscotto Digitale Assenze</h1>
        </header>
            ...
            <form action="">
                <div style="display: flex;flex-wrap: nowrap;align-content: flex-start;justify-content: center;align-items: center;">
                    ...
                    <div style="display: flex;flex-direction: column;">                                         
                        <button type="button" onclick="creaTabellaOperatoreAssenzeSede()">Assenze Sede</button>           
                    </div>
                    <div style="display: flex;flex-direction: column;">                                         
                        <button type="button" onclick="creaTabellaOperatoreAssenze();pdpInternoVuoto();pdpEsternoVuoto()">Assenze Operatori</button>           
                    </div>
                                        <div style="display: flex;flex-direction: column;">                                         
                        <button type="button" onclick="creaTabellaOperatoreAssenzeSedeSettimana()">Assenze Sede Settimane</button>           
                    </div>
                </div>
            </form>
        </div>
        <div>
            <a id="assenza" style="display:flex;flex-wrap: nowrap;align-items: flex-start;flex-direction: column;align-content: center;justify-content: space-between;"></a>
        </div>
        <br>
        <div>
        ...
        <br>
        <div >
            <a id="settimana" style="display:flex;flex-wrap: nowrap;align-items: flex-start;flex-direction: row;align-content: center;justify-content: space-between;"></a>
        </div>
        <br>
        <div >
