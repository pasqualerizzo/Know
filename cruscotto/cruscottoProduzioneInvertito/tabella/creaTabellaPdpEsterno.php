    ...
    switch ($idMandato) {
        case "Plenitude":
            $queryCrm = "SELECT "
                    ...
                    . "where mese='$mese'  and comodity<>'Polizza' AND fasePDA='OK' "
                    . $querySede
                    . "group by statoPost";
            ...
            $queryCrmRange = "SELECT "
                    ...
                    . "`plenitude`  "
                    . "inner join aggiuntaPlenitude ON  plenitude.id=aggiuntaPlenitude.id "
                    . "where    comodity<>'Polizza' AND fasePDA='OK' "
...
//            echo $queryCrm;
        ...
        case "Green Network":
            $queryCrm = "SELECT "
                    ...
                    . "where mese='$mese' and statoPda<>'bozza' and statoPda<>'annullata' and statoPda<>'pratica doppia' and statoPost<>'' "
                    . $querySede
                    . "group by statoPost";
            $queryCrmRange = "SELECT "
                    . " COUNT(statoPost) ,SUM(if((fasePost='OK'),1,0)),SUM(if((fasePost='KO'),1,0)),SUM(if((fasePost='BKL'),1,0)),SUM(if((fasePost='BKLP'),1,0)),SUM(if((fasePost=''),1,0)) "
                    ...
                    . "green "
                    . "inner JOIN aggiuntaGreen on green.id=aggiuntaGreen.id "
                    . "where   statoPda<>'bozza' and statoPda<>'annullata' and statoPda<>'pratica doppia' and statoPost<>'' "
                    . "and data<='$dataMaggiore'and data>='$dataMinore' "
                    . $querySede;
        ...
        case "Vivigas Energia":
            $queryCrm = "SELECT "
                    . "statoPost, fasePost, sum(pezzoLordo) ,SUM(if((datasottoscrizionecontratto<='$dataMaggiore'and datasottoscrizionecontratto>='$dataMinore'),pezzoLordo,0)) "
                    . "FROM "
                    . "vivigas "
                    . "inner JOIN aggiuntaVivigas on vivigas.id=aggiuntaVivigas.id "
                    . "where mese='$mese' AND statoPda IN ('Ok Definitivo', 'Ok inserito')  "
                    . $querySede
                    . "group by statoPost";
//echo $queryCrm;
            $queryCrmRange = "SELECT "
                    ...
                    . "vivigas "
                    . "inner JOIN aggiuntaVivigas on vivigas.id=aggiuntaVivigas.id "
                    . "where   statoPda IN ('Ok Definitivo', 'Ok inserito')  "
                    . "and datasottoscrizionecontratto<='$dataMaggiore'and datasottoscrizionecontratto>='$dataMinore' "
                    . $querySede;
...
//       echo $queryCrm;     
        ...
        case "enel_out":
            ...
            $queryCrm = "SELECT "
                    ...
                    . "where mese='$mese'  and fasePDA='OK' "
                    . $querySede
                    . "group by statoPost";
...
//            echo $queryCrm;
            ...
            $queryCrm = "SELECT "
                    ...
                    . "where mese='$mese'  and fasePDA='OK' and comodity <> 'Consenso' "
                    . $querySede
                    . "group by statoPost";
//echo $queryCrm;
            $queryCrmRange = "SELECT "
                    ...
                    . "heracom "
                    . "inner join aggiuntaHeracom ON  heracom.id=aggiuntaHeracom.id "
                    . "where  fasePDA='OK' and comodity <> 'Consenso' "
                    . "and data<='$dataMaggiore'and data>='$dataMinore' "
                    . $querySede;
...
//            echo $queryCrmTotale;
            ...
            $queryCrm = "SELECT "
                    ...
                    . "where mese='$mese'  and fasePDA='OK' and comodity<>'Fibra Enel'"
                    . $querySede
                    . "group by statoPost";
...
//            echo $queryCrm;
            ...
            $queryCrmRange = "SELECT "
                    ...
                    . "inner join aggiuntaEnelIn ON  enelIn.id=aggiuntaEnelIn.id "
                    . "where  fasePDA='OK' "
                    . "and data<='$dataMaggiore'and data>='$dataMinore' and comodity<>'Fibra Enel'"
                    . $querySede;
//echo $queryCrmRange;    
            $queryCrmTotale = "SELECT "
                    . " COUNT(statoPost) ,SUM(if((fasePost='OK'),1,0)),SUM(if((fasePost='KO'),1,0)),SUM(if((fasePost='BKL'),1,0)),SUM(if((fasePost='BKLP'),1,0)),SUM(if((fasePost=''),1,0)) "
...
//        include "creaTabellaCu.php";
//        $html .= $outputDellaTabellaCu; // assumendo che creaTabellaCu.php assegni l'output a una variabile
//    }
...
if ($idMandato == 'Plenitude') {
    include "creaTabellaPdpEsternoPolizze.php";
}

if ($idMandato == 'Heracom') {
    require "creaTabellaCu.php"; // Carica la funzione
    $tabellaCu = generaTabellaCu($conn19, $dataMinore, $dataMaggiore);
    
    // Aggiungi spazio (scegli una delle opzioni):
    $html .= "<br><br>"; // Doppia riga vuota
    $html .= "<br><br>"; // Doppio spazio
    $html .= "<br><br>"; // Doppio spazio
    $html .= "<br><br>"; // Doppio spazio
    // OPPURE:
    $html .= "<div style='margin-top: 20px;'></div>"; // Spazio personalizzato
    // OPPURE:
    $html .= "<hr>"; // Linea orizzontale
    
    $html .= $tabellaCu; // Aggiungi la seconda tabella
}
