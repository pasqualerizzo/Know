...
if ($idMandato == 'Plenitude') {
    include "/Applications/MAMP/htdocs/Know/cruscotto/tabella/creaTabellaPdpInternoPolizzeGiornaliero.php";
    include "/Applications/MAMP/htdocs/Know/cruscotto/tabella/creaTabellaInvertitoPdpEsternoLead.php";
    include "/Applications/MAMP/htdocs/Know/cruscotto/tabella/creaTabellaPdpEsternoPolizzeLead.php";
    include "/Applications/MAMP/htdocs/Know/cruscotto/tabella/creaTabellaMacroKoInbound.phpp";
}
echo $html;
