...
//echo $queryMortalitaLuce;
    ...
    case "Green Network":
        $queryCrm = "SELECT "
                ...
                . "and statoPda<>'bozza' and statoPda<>'annullata' and statoPda<>'pratica doppia'  and a.tipoCampagna = 'Lead'"
                . " group by sede";
        break;
    case "Vivigas Energia":
        $queryCrm = "SELECT 
    ...
    SUM(IF(a.fasePost='KO', a.totalePesoLordo, 0)) AS pesoPostKO,
    SUM(IF(a.fasePost='BKL', a.totalePesoLordo, 0)) AS pesoPostBKL,
    SUM(IF(v.metodoPagamento='Bollettino' AND a.fasePDA='OK', a.pezzoLordo, 0)) AS pezziBollettinoOK,
    SUM(IF(v.metodoPagamento='SSD' AND a.fasePDA='OK', a.pezzoLordo, 0)) AS pezziSSDOK,
    SUM(IF(v.metodoInvio='Posta (Residenza)', a.pezzoLordo, 0)) AS pezziPosta,
    SUM(IF(v.metodoInvio='Mail', a.pezzoLordo, 0)) AS pezziMail,
    SUM(IF(v.comodity='Luce', a.pezzoLordo, 0)) AS pezziLuce,
    SUM(IF(v.comodity='Gas', a.pezzoLordo, 0)) AS pezziGas,
    SUM(IF(v.comodity='Dual', a.pezzoLordo, 0)) AS pezziDual,
    SUM(IF(v.comodity='Polizza', a.pezzoLordo, 0)) AS pezziPolizza,
    SUM(IF(v.metodoPagamento='Bollettino' AND a.fasePDA='OK', a.pezzoLordo, 0)) AS pezziBollettinoConfermati,
    SUM(IF(v.metodoPagamento='SSD' AND a.fasePDA='OK', a.pezzoLordo, 0)) AS pezziSSDConfermati,
    SUM(IF(v.metodoInvio='Posta (Residenza)' AND a.fasePDA='OK', a.pezzoLordo, 0)) AS pezziPostaConfermati,
    SUM(IF(v.metodoInvio='Mail' AND a.fasePDA='OK', a.pezzoLordo, 0)) AS pezziMailConfermati,
    0 AS placeholder1,
    0 AS placeholder2,
    0 AS placeholder3,
    0 AS placeholder4,
...
//      echo $queryCrm;
    ...
    case "Vodafone":
        $queryCrm = "SELECT "
                ...
                . "where data<='$dataMaggiore' and data>='$dataMinore' " . $querySede
                . "and statoPda<>'bozza' and statoPda<>'annullata' and statoPda<>'pratica doppia'  and a.tipoCampanga = 'Lead'"
                . " group by sede";
        break;
    case "enel_out":
        $queryCrm = "SELECT "
