...
$queryCrm = "SELECT
   ...
   SUM(
    IF(
        fasePDA <> '' AND comodity = 'Polizza', 
        totalePesoLordo, 
        0
    )
),
    SUM(IF(fasePDA = 'OK' AND comodity = 'Polizza', totalePesoLordo, 0)),
    SUM(IF(fasePDA = 'KO' AND comodity = 'Polizza', totalePesoLordo, 0)),
    SUM(IF(fasePDA = 'BKL' AND comodity = 'Polizza', totalePesoLordo, 0)),
    SUM(IF(fasePDA = 'BKLP' AND comodity = 'Polizza', totalePesoLordo, 0)),
    SUM(
    IF(
        fasePDA <> '' AND comodity = 'Polizza',
        pezzoLordo,
    ...
    SUM(IF(fasePDA = 'OK' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(fasePDA = 'KO' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(fasePDA = 'BKL' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(fasePDA = 'BKLP' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(fasePost = 'OK' AND fasePDA = 'OK' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(fasePost = 'KO' AND fasePDA = 'OK' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(fasePost = 'BKL' AND fasePDA = 'OK' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(fasePost = 'OK' AND comodity = 'Polizza', totalePesoLordo, 0)),
    SUM(IF(fasePost = 'KO' AND comodity = 'Polizza', totalePesoLordo, 0)),
    SUM(IF(fasePost = 'BKL' AND comodity = 'Polizza', totalePesoLordo, 0)),
    SUM(IF(metodoPagamento = 'Bollettino Postale' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(metodoPagamento = 'RID' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(metodoInvio = 'Cartaceo' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(metodoInvio = 'Bollettaweb' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(comodity = 'Luce' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(comodity = 'Gas' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(comodity = 'Dual' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(metodoPagamento = 'Bollettino Postale' AND fasePDA = 'OK' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(metodoPagamento = 'RID' AND fasePDA = 'OK' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(metodoInvio = 'Cartaceo' AND fasePDA = 'OK' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(metodoInvio = 'Bollettaweb' AND fasePDA = 'OK' AND comodity = 'Polizza', pezzoLordo, 0)),
    SUM(IF(fasePDA = 'OK' AND comodity <> 'Polizza', pezzoLordo, 0)),
    SUM(IF(fasePost = 'OK' AND fasePDA = 'OK' AND comodity <> 'Polizza', pezzoLordo, 0))
FROM
    plenitude
...
include "../../tabella/intestazioneTabellaPlz.php";
