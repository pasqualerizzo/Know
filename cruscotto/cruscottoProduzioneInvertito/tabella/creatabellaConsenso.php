...
$queryCrm = "SELECT
   ...
   SUM(
    IF(
        fasePDA <> '' AND comodity = 'Consenso', 
        totalePesoLordo, 
        0
    )
),
    SUM(IF(fasePDA = 'OK' AND comodity = 'Consenso', totalePesoLordo, 0)),
    SUM(IF(fasePDA = 'KO' AND comodity = 'Consenso', totalePesoLordo, 0)),
    SUM(IF(fasePDA = 'BKL' AND comodity = 'Consenso', totalePesoLordo, 0)),
    SUM(IF(fasePDA = 'BKLP' AND comodity = 'Consenso', totalePesoLordo, 0)),
    SUM(
    IF(
        fasePDA <> '' AND comodity = 'Consenso',
        pezzoLordo,
    ...
    SUM(IF(fasePDA = 'OK' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(fasePDA = 'KO' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(fasePDA = 'BKL' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(fasePDA = 'BKLP' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(fasePost = 'OK' AND fasePDA = 'OK' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(fasePost = 'KO' AND fasePDA = 'OK' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(fasePost = 'BKL' AND fasePDA = 'OK' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(fasePost = 'OK' AND comodity = 'Consenso', totalePesoLordo, 0)),
    SUM(IF(fasePost = 'KO' AND comodity = 'Consenso', totalePesoLordo, 0)),
    SUM(IF(fasePost = 'BKL' AND comodity = 'Consenso', totalePesoLordo, 0)),
    SUM(IF(metodoPagamento = 'Bollettino Postale' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(metodoPagamento = 'RID' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(metodoInvio = 'Cartaceo' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(metodoInvio = 'Bollettaweb' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(comodity = 'Luce' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(comodity = 'Gas' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(comodity = 'Dual' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(metodoPagamento = 'Bollettino Postale' AND fasePDA = 'OK' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(metodoPagamento = 'RID' AND fasePDA = 'OK' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(metodoInvio = 'Cartaceo' AND fasePDA = 'OK' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(metodoInvio = 'Bollettaweb' AND fasePDA = 'OK' AND comodity = 'Consenso', pezzoLordo, 0)),
    SUM(IF(fasePDA = 'OK' AND comodity <> 'Consenso', pezzoLordo, 0)),
    SUM(IF(fasePost = 'OK' AND fasePDA = 'OK' AND comodity <> 'Consenso', pezzoLordo, 0))
FROM
    heracom
...
include "../../tabella/intestazioneTabellaConsenso.php";
