...
$html .= "<thead>";
$html .= "<tr>";
$html .= "<th colspan='6'>DETTAGLIO PDP Esterno SW VOL</th>";
$html .= "</tr>";
$html .= "<tr>";
$html .= "<th>Mandato</th>";
    ...
    switch ($idMandato) {
        case "Plenitude":
            $queryCrm = "SELECT "
                    ...
                    . "where mese='$mese'  and comodity<>'Polizza' AND fasePDA='OK' AND tipoAcquisizione <>'Subentro' "
                    . $querySede
                    . "group by statoPost";
            ...
            $queryCrmRange = "SELECT "
                    ...
                    . "`plenitude`  "
                    . "inner join aggiuntaPlenitude ON  plenitude.id=aggiuntaPlenitude.id "
                    . "where    comodity<>'Polizza' AND fasePDA='OK' AND tipoAcquisizione <>'Subentro' "
