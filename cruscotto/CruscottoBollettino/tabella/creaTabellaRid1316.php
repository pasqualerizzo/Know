...
WHERE datasottoscrizionecontratto = CURRENT_DATE 
  ...
  AND TIME(STR_TO_DATE(orariofirma, '%Y-%m-%d %H:%i:%s')) BETWEEN '13:00:00' AND '15:59:59'
GROUP BY sede";
...
$tabella="<table border='3' style='width: 100%; font-size: 36px;'>
                <tr><td colspan='3' style='background-color: purple; color: white; width: 100%; height: 100%; font-size: 30px;'>RID SW&VOLT 13-16</td></tr>
...
$tabella.="<tr><td style='background-color: blue; color: white; width: 100%; height: 100%; font-size: 40px;'>TOTALE</td><td style='background-color: blue; color: white; width: 100%; height: 100%; font-size: 40px'>". - (38 - $totale_actual)."</td><td style='background-color: blue; color: white; width: 100%; height: 100%; font-size: 40px'>".$totale_actual."</td></tr>";
