...
WHERE datasottoscrizionecontratto = CURRENT_DATE 
  ...
  AND TIME(STR_TO_DATE(orariofirma, '%Y-%m-%d %H:%i:%s')) BETWEEN '16:00:00' AND '19:59:59'
GROUP BY sede";
...
$tabella="<table border='3' style='width: 100%; font-size: 36px;'>
                <tr><td colspan='3' style='background-color: purple; color: white; width: 100%; height: 100%; font-size: 30px;'>RID SW&VOLT 16-19</td></tr>
