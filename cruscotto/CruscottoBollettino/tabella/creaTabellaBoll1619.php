...
WHERE DATE(STR_TO_DATE(cf.cf_2162, '%Y-%m-%d %H:%i:%s')) = CURRENT_DATE 
  ...
  AND TIME(STR_TO_DATE(cf.cf_2162, '%Y-%m-%d %H:%i:%s')) BETWEEN '16:00:00' AND '18:59:59'
GROUP BY p.sede";
...
$tabella="<table border='3' style='width: 100%; font-size: 36px;'>
                <tr><td colspan='3' style='background-color: orange; color: white; width: 100%; height: 100%; font-size: 30px;'>BOLL SW&VOLT 16-19</td></tr>
...
$tabella.="<tr><td style='background-color: blue; color: white; width: 100%; height: 100%; font-size: 40px;'>TOTALE</td><td style='background-color: blue; color: white; width: 100%; height: 100%; font-size: 40px'>". - (17 - $totale_actual)."</td><td style='background-color: blue; color: white; width: 100%; height: 100%; font-size: 40px'>".$totale_actual."</td></tr>";
