...
$html = "<html>";
$html .= "<head>";
$html .= "<title>Cruscotto Ore</title>";
$html .= "<link href='Know/../../../css/tabella.css' rel='stylesheet'>";
$html .= "</head>";
$html .= "<body>";
$html .= "<header>";
$html .= "<h1>Cruscotto Ore</h1>";
$html .= "</header>";
$html .= "<table class='blueTable'>";
include "/Applications/MAMP/htdocs/Know/cruscotto/funzioni/tabella/intestazioneTabella.php";
...
if ($idMandato == 'Plenitude') {
    include "/Applications/MAMP/htdocs/Know/cruscotto/funzioni/creaTabellaPolizze.php";
}
