...
$html .= "<th colspan='3' style='background-color:mediumseagreen;border-left: 2px solid lightslategray'>Resa su Inserito</th>";
...
$html .= "<th colspan='3' style='background-color: #f65936;border-left: 2px solid lightslategray'>Obiettivo Mensile</th>";
$html .= "<th colspan='3' style='background-color: #e19d9d;border-left: 2px solid lightslategray'>Paf Mensile</th>";
...
$html .= "<th style='background-color:mediumseagreen;border-left: 2px solid lightslategray'>Su PDA</th>";
$html .= "<th style='background-color:mediumseagreen'>Su Valore</th>";
$html .= "<th style='background-color:mediumseagreen'>R/h</th>";
...
$html .= "<th style='background-color: #f65936;border-left: 2px solid lightslategray'>Mensile</th>";
$html .= "<th style='background-color: #f65936;border-left: 2px solid lightslategray'>Passo Giorno</th>";
$html .= "<th style='background-color: #f65936;border-left: 2px solid lightslategray'>Differenza Obj</th>";


$html .= "<th style='background-color: #e19d9d;border-left: 2px solid lightslategray'>Ore Paf</th>";
$html .= "<th style='background-color: #e19d9d'>Pezzi Paf</th>";
$html .= "<th style='background-color: #e19d9d'>Resa Paf</th>";
...
$html .= "<th style='background-color: #289ee1'>Polizze</th>";
