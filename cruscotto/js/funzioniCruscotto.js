...
function aggiornaMandatoInvertito() {
    const dataMinore = document.getElementById("dataInizio").value;
    const dataMaggiore = document.getElementById("dataFine").value;
...
function aggiornaSedeInvertito() {
    ...
    const valoriMandato = Array.from(mandato.selectedOptions).map(o => o.value);
    const data = new FormData();
    data.append("dataMinore", dataMinore);
    data.append("dataMaggiore", dataMaggiore);
    data.append("mandato", JSON.stringify(valoriMandato));
    ...
    fetch("/Know/cruscotto/funzioni/aggiornaSedeInvertito.php", {
        ...
        .then(response => {
            ...
            if (sede.options.length > 0) sede.options[0].selected = true;
        }).catch(console.error);
}
...
function creaTabellaLeadKLpiSub2() {
    var dataMinore = document.getElementById("dataInizio").value;
    var dataMaggiore = document.getElementById("dataFine").value;
    var data = new FormData();
    data.append("dataMinore", dataMinore);
...
//    data.append("agenzia", JSON.stringify(valoreAgenzia));
    ...
    fetch("../CruscottoKpiSUB/tabella/creatabellakpiSubmandati2.php", {
        method: "POST",
        body: data,
        redirect: 'manual'
    }).then(response => response.text())
...
function creaTabellaInvertitoSubUno() {
    var dataMinore = document.getElementById("dataInizio").value;
    var dataMaggiore = document.getElementById("dataFine").value;
    var mandato = document.getElementById("mandato");
    var testMode = document.getElementById("testMode").checked;
    ...
    data.append("mandato", JSON.stringify(valoreMandato));
    data.append("sede", JSON.stringify(valoreSede));
    fetch("../CruscottoProduzioneSubUno/tabella/creaTabellaInvertitoSubUno.php", {
        method: "POST",
        body: data,
        redirect: 'manual'
    }).then(response => response.text())
...
function creaTabellaPdpSubUno() {
    ...
    data.append("mandato", JSON.stringify(valoreMandato));
    data.append("sede", JSON.stringify(valoreSede));
    fetch("../CruscottoProduzioneSubUno/tabella/creaTabellaInveritoPdpInternoSubUno.php", {
        method: "POST",
        body: data,
        redirect: 'manual'
    }).then(response => response.text())
...
function creaTabellaPdpEsternoSubUno() {
    var dataMinore = document.getElementById("dataInizio").value;
    var dataMaggiore = document.getElementById("dataFine").value;
    var mandato = document.getElementById("mandato");
    var valoreMandato = [];
    ...
    data.append("mandato", JSON.stringify(valoreMandato));
    data.append("sede", JSON.stringify(valoreSede));
    fetch("../CruscottoProduzioneSubUno/tabella/creaTabellaPdpEsternoSubUno.php", {
        method: "POST",
        body: data,
        redirect: 'manual'
    }).then(response => response.text())
...
function creaTabellaInvertitoSubMandatiDue() {
    var dataMinore = document.getElementById("dataInizio").value;
    var dataMaggiore = document.getElementById("dataFine").value;
    var mandato = document.getElementById("mandato");
    var testMode = document.getElementById("testMode").checked;
    ...
    data.append("mandato", JSON.stringify(valoreMandato));
    data.append("sede", JSON.stringify(valoreSede));
    fetch("../CruscottoProduzioneSubMandatiDue/tabella/creaTabellaInvertitoSubMandatiDue.php", {
        method: "POST",
        body: data,
        redirect: 'manual'
    }).then(response => response.text())
...
function creaTabellaPdpSubMandatiDue() {
    var dataMinore = document.getElementById("dataInizio").value;
    var dataMaggiore = document.getElementById("dataFine").value;
    var mandato = document.getElementById("mandato");
    var valoreMandato = [];
    ...
    data.append("mandato", JSON.stringify(valoreMandato));
    data.append("sede", JSON.stringify(valoreSede));
    fetch("../CruscottoProduzioneSubMandatiDue/tabella/creaTabellaInveritoPdpInternoSubMandatiDue.php", {
        method: "POST",
        body: data,
        redirect: 'manual'
    }).then(response => response.text())
...
function creaTabellaPdpEsternoSubMandatiDue() {
    var dataMinore = document.getElementById("dataInizio").value;
    var dataMaggiore = document.getElementById("dataFine").value;
    var mandato = document.getElementById("mandato");
    var valoreMandato = [];
    ...
    data.append("mandato", JSON.stringify(valoreMandato));
    data.append("sede", JSON.stringify(valoreSede));
    fetch("../CruscottoProduzioneSubMandatiDue/tabella/creaTabellaPdpEsternoSubMandatiDue.php", {
        method: "POST",
        body: data,
        redirect: 'manual'
    }).then(response => response.text())
...
function creaTabellaMatricolaSubUno() {
    var dataMinore = document.getElementById("dataInizio").value;
    var dataMaggiore = document.getElementById("dataFine").value;
    var mandato = document.getElementById("mandato");
    var valoreMandato = [];
    ...
    data.append("mandato", JSON.stringify(valoreMandato));
    data.append("sede", JSON.stringify(valoreSede));
    fetch("../CruscottoProduzioneSubUno/tabella/creaTabellaCodiceMatricolaSubUno.php", {
        method: "POST",
        body: data,
        redirect: 'manual'
    }).then(response => response.text())
...
function creaTabellaMatricolaSubMandatiDue() {
    var dataMinore = document.getElementById("dataInizio").value;
    var dataMaggiore = document.getElementById("dataFine").value;
    var mandato = document.getElementById("mandato");
    var valoreMandato = [];
    ...
    data.append("mandato", JSON.stringify(valoreMandato));
    data.append("sede", JSON.stringify(valoreSede));
    fetch("../CruscottoProduzioneSubMandatiDue/tabella/creaTabellaCodiceMatricolaSubMandatiDue.php", {
        method: "POST",
        body: data,
        redirect: 'manual'
    }).then(response => response.text())
...
function creaTabellaLeadKpiPlenitude() {
    ...
    fetch("../CruscottoKpiLeadPlenitude/creaTabellakpileadplenitude.php", {
        method: "POST",
        body: data,
        redirect: 'manual'
    }).then(response => response.text())
...
function creaTabellaGiornalieroSwVolTotale() {
    var dataMinore = document.getElementById("dataInizio").value;
    var dataMaggiore = document.getElementById("dataFine").value;
    var mandato = document.getElementById("mandato");
    var testMode = document.getElementById("testMode").checked;
    ...
    data.append("mandato", JSON.stringify(valoreMandato));
    data.append("sede", JSON.stringify(valoreSede));
    fetch("../cruscottoProduzioneInvertito/tabella/creaTabellaInvertitoSwVolTotale.php", {
        method: "POST",
        body: data,
        redirect: 'manual'
    }).then(response => response.text())
