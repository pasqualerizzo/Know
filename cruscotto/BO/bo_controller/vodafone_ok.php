...
$query1= 'SELECT count(vodafoneid) as AVANZAMENTO, cf_3146 AS STATO_PDA FROM `vtiger_vodafonecf`  WHERE cf_2986 = CURRENT_DATE and (cf_3146 = "OK INSERITO" or cf_3146 = "OK DEFINITIVO") GROUP BY cf_3146 limit 1000';
