...
$query1= 'SELECT count(plenitudeid) as AVANZAMENTO, statopda AS STATO_PDA FROM `vtiger_plenitude`  WHERE datasottoscrizionecontratto = CURRENT_DATE and (commodity <> "Polizza" and statopda = "Ok firma") GROUP BY statopda  limit 1000';
