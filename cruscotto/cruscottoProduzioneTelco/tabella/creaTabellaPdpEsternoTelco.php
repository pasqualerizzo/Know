...
foreach ($mandato as $idMandato) {
    switch ($idMandato) {
        case "Tim":
            $queryCrm = "SELECT "
                    . "statoPlico, fasePost, COUNT(statoPlico) ,SUM(if((dataVendita<='$dataMaggiore'and dataVendita>='$dataMinore'),1,0)) "
                    . "FROM "
                    . "`tim`  "
            ...
            $queryCrmRange = "SELECT "
                    . " COUNT(statoPlico) ,SUM(if((fasePost='OK'),1,0)),SUM(if((fasePost='KO'),1,0)),SUM(if((fasePost='BKL'),1,0)),SUM(if((fasePost='BKLP'),1,0)),SUM(if((fasePost=''),1,0)) "
                    . "FROM "
                     . "`tim`  "
                    . "inner join aggiuntaTim ON  tim.id=aggiuntaTim.id "
                    . "where    fasePDA='OK' "
                    . "and dataVendita<='$dataMaggiore'and dataVendita>='$dataMinore' "
                    . $querySede;
//echo $queryCrmRange;
