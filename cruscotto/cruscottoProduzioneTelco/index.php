...
<html>
    <head>
        <title>Metrics:Cruscotto Produzione Telco</title>
    ...
    <body style="font-family: poppins;" onload="aggiornaMandatoTelco();permessi()">
        <header>
            <h1>Metrics:Cruscotto Produzione Telco</h1>
        </header>
                ...
                <div style="display: flex;flex-wrap: nowrap;align-content: flex-start;justify-content: center;align-items: center;">
                    ...
                    <div style="display: flex;width: 25%;align-content: space-between;align-items: stretch;justify-content: space-between;flex-direction: column;flex-wrap: nowrap;">
                        <label for="dataInizio">Data Inizio:
                            <input type="date" id="dataInizio" name="dataInizio" max="<?= $dataMassima ?>"  min="<?= $dataMinima ?>" value="<?= $dataDefault ?>" onchange="aggiornaMandatoTelco();aggiornaSedeInvertito()" > 
                        </label>
                        <br>
                        <label for="dataFine">Data  Fine: 
                            <input type="date" id="dataFine" name="datafine" max="<?= $dataMassima ?>"  min="<?= $dataMinima ?>" value="<?= $dataDefault ?>" onchange="aggiornaMandatoTelco();aggiornaSedeInvertito()">
                        </label>
                    </div>
                    ...
                    <div style="display: flex;flex-direction: column;">
                        ...
                        <button type="button" onclick="creaTabellaTelco(); creaTabellaPdpTelco(); creaTabellaPdpEsternoTelco()">Aggiorna</button>
                     </div>
                </div>
            </form>
        </div>
