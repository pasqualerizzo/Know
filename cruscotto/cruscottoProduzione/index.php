...
<html>
    ...
    <body style="font-family: poppins;" onload="aggiornaMandato();permessi()">
        <header>
            <h1>Metrics:Cruscotto Produzione</h1>
        </header>
            ...
            <form action="">
                <div style="display: flex;flex-wrap: nowrap;align-content: flex-start;justify-content: center;align-items: center;">
                    ...
                    <div style="display: flex;width: 25%;align-content: center;align-items: center;justify-content: space-evenly;">
                        <label>Mandato:</label>
                        <select  size="4" multiple id="mandato" onchange="aggiornaSede()">
                    ...
                    <div style="display: flex;flex-direction: column;">
                        <label>Test Mode<input type="checkbox" id="testMode" name="testMode" value="test"></label>
                        <button type="button" onclick="creaTabella();creaTabellaPdp();creaTabellaPdpEsterno()">Aggiorna</button>                        
                        <button type="button" onclick="creaTabellaGiornaliero();creaTabellaPdpGiornaliero();pdpEsternoVuoto()">Giornaliero</button>                        
                    </div>
                </div>
            </form>
        </div>
