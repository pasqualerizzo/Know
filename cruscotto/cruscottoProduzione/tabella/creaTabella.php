        ...
        if ($sede <> $sedeSuccessiva) {
            if ($sedeSuccessiva == null) {
                ...
                if (($pezzoCartaceoTotale + $pezzoMailTotale) == 0) {
                    ...
                    $percentualeInvioTotale = ($pezzoMailTotale / ($pezzoCartaceoTotale + $pezzoMailTotale)) * 100;
                }
                ...
                if (($pezzoBollettinoOkTotale + $pezzoRidOkTotale) == 0) {
                    $percentualeBollettinoOkTotale = 0;
                } else {
                    $percentualeBollettinoOkTotale = round((($pezzoBollettinoOkTotale / ($pezzoBollettinoOkTotale + $pezzoRidOkTotale)) * 100), 2);
                }
                if (($pezzoCartaceoOkTotale + $pezzoMailOkTotale) == 0) {
                    $percentualeInvioOkTotale = 0;
                } else {
                    $percentualeInvioOkTotale = ($pezzoMailOkTotale / ($pezzoCartaceoOkTotale + $pezzoMailOkTotale)) * 100;
                }
