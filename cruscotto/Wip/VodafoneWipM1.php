...
$query1= "SELECT COUNT(vodafoneid) AS WIP, cf_3146 AS STATO_PDA FROM `vtiger_vodafonecf` WHERE DATE_FORMAT(cf_2986, '%Y-%m') = DATE_FORMAT(DATE_SUB(CURRENT_DATE, INTERVAL 1 MONTH), '%Y-%m') AND cf_4134 = 'Wip' GROUP BY cf_3146 LIMIT 1000";
...
$tabella="<table  border=2>
                <tr><td colspan='2' style='background-color: red; color: white;  width: 100%; height: 100%; font-size: 30px'>WIP MESE -1</td></tr>
