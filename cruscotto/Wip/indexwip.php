<html>
    ...
    <body    font-family: Arial, sans-serif; >
        ...
        <h1 style="text-align: center;width: 100%;height: 10%;">Wip Vodafone</h1>
        ...
        <div style="display: flex;
            ...
            <div id="colonna1" style="border: 4px solid purple; margin-top: 40px;  font-size: 10vw;width: 100%;height:100%"></div>
            <div id="colonna2" style="border: 4px solid purple; margin-top: 40px;  font-size: 10vw;width: 100%;height:100%"></div>
