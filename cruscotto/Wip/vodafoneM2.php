...
$query1= "SELECT COUNT(vodafoneid) AS PEZZI, cf_3146 AS STATO_PDA FROM `vtiger_vodafonecf` WHERE DATE_FORMAT(cf_2986, '%Y-%m') = DATE_FORMAT(DATE_SUB(CURRENT_DATE, INTERVAL 2 MONTH), '%Y-%m') AND cf_3146 = 'OK DEFINITIVO' GROUP BY cf_3146 LIMIT 1000";
...
$tabella="<table  border=2>
                <tr><td colspan='2' style='background-color: red; color: white;  width: 100%; height: 100%; font-size: 30px'>PEZZI MESE -2</td></tr>
