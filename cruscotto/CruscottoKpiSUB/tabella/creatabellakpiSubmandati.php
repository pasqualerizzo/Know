...
//    $risultatoOre = $connDgt->query($queryOre);
//
//    while (($rigaOre = $risultatoOre->fetch_array())) {
//        $operatore = $rigaOre['operatore'];
//        $oreIN = round($rigaOre['oreSPN_VDF'], 2);
...
//            $livello = $rigaOre['livello'];
//        }
//        $siscallDGT[$operatore] = [$oreIN, $oreOut, $sede, $livello];
//    }
}
...
$html .= "<th onclick='sortTableNumeroKPI(17)'>Livello Vicidial</th>";
...
// Ora puoi utilizzare $okVodaOut, $koVodaOut e $totVodaOut
    ...
    $totaleProdotto = $totPleni + $totIren + $totVivi + $totUnion + $totVoda;
    $okProdotto = $okPleni + $okVivi + $okIren + $okUnion + $okVoda;
    $koProdotto = $koPleni + $koVivi + $koIren + $koUnion + $koVoda;
    $convertito = $convertitoPleni + $convertitoVivi + $convertitoIren + $convertitoUnion + $convertitoUnion;
    $OkProduzioneOut = $okPleniOut + $okViviOut + $okUnionOut + $okVodaOut;
    $Okpvtotale = $okPlenipv + $okVodaPv + $okUnionPv + $OkViviPv;
...
//     echo $queryPleni;
    ...
    $okWeek = $okPleni + $okVivi + $okIren + $okVoda + $okUnion;
