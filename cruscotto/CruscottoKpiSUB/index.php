...
<html>
    <head>
        <title>Metrics: Cruscotto KPI Lead Operatore BMP</title>
    ...
    <body style="font-family: poppins;" onload="permessi()">
        <header>
            <h1>Metrics: Cruscotto KPI Lead Operatore BMP</h1>
        </header>
            ...
            <form action="">
                <div style="display: flex;flex-wrap: nowrap;align-content: flex-start;justify-content: space-around;align-items: center;">
                    ...
                    <div style="display: flex;align-content: center;align-items: center;justify-content: space-evenly;">                                         
                        <button type="button" onclick="creaTabellaLeadKLpiSub2();pdpInternoVuoto();pdpEsternoVuoto();resetKpi()">Aggiorna KPI BMP</button>           
                    </div>
                    
                    
<!--                    <div style="display: flex;;align-content: center;align-items: center;justify-content: space-evenly;">
                        <label>Categoria:</label>
                        <div style="display: flex;align-content: center;align-items: flex-end;justify-content: center;flex-direction: column;">
                        <label>Energy
                            <input type="checkbox" value="Energy" id="ceckEnergy"  onchange="filtroEnergyKpi();">
                        </label>
                        <br>
                        <label>Telco
                        <input type="checkbox" value="Telco" id="ceckTelco"  onchange="filtroEnergyKpi();">
                        </label>
                        </div>
                    </div>-->
                    ...
                    <div style="display: flex;align-content: center;align-items: center;justify-content: space-evenly;">
                        ...
                        <select  size="4" multiple id="sede" onchange="filtroEnergyKpi()" >
                        </select>   
                    </div>
