...
while ($rigaMandato = $risultatoQueryGroupMandato->fetch_array()) {
    ...
    $totale = $pleniTot + $vodaTot + $viviTot + $irenTot + $unionTot + $enelTot;
    $ok = $pleniOk + $vodaOk + $viviOk + $irenOk + $unionOk + $enelOk;
    $ko = $pleniKo + $vodaKo + $viviKo + $irenKo + $unionKo + $enelKo;
    $valoreMedio = $valorePleni + $valoreVoda + $valoreVivi + $valoreIren + $valoreUnion + $valoreEnel;
