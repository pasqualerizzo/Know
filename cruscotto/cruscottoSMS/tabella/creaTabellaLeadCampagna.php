...
while ($rigaCosto = $risultatoQueryGroupCosto->fetch_array()) {
    ...
    $queryGroupMandato = "SELECT "
            ...
            . " sum(`pleniTot`+`vodaTot`+`viviTot`+`irenTot`+`uniTot`+enelTot),"
            . " sum(`pleniOk`+`vodaOk`+`viviOk`+`irenOk`+`uniOk`+enelOk),"
            . " sum(`pleniKo`+`vodaKo`+`viviKo`+`irenKo`+`uniKo`+enelKo), "
            . " sum(`valoreMediaPleni`+`valoreMediaVivi`+`valoreMedioVoda`+`valoreMedioIren`+`valoreMedioUni`+valoreMedioEnel) "
            . " FROM "
            . " `gestioneLead` "
