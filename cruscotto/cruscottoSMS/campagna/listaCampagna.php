...
$query = "SELECT * FROM `campagnaMarketing`";
...
<html>
    <head>
        <title>Lista Campagna Marketing</title>
    ...
    <body>
        <header>
            <h1 class="titolo">Lista Campagna Marketing</h1>
        ...
        <div class="pagina">
            <div>
                ...
                <button onclick="aggiungiCampagna()">Aggiungi Campagna</button>
 ...
 function aggiungiCampagna() {
            window.location.href = "aggiuntaCampagna.php";
        }
