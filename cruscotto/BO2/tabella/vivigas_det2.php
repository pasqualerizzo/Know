...
require_once 'connessioni.php';

$query3= 'SELECT * FROM `vtiger_plenitudecf` WHERE cf_3563 = CURRENT_DATE and cf_3673 = "Acquisito"  and ( codicecampagna <> "SPN_LEAD") limit 10';
