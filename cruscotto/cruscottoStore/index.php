...
<html>
    <head>
        <title>Metrics: Cruscotto Store</title>
                ...
                <div style="display: flex;flex-wrap: nowrap;align-content: flex-start;justify-content: center;align-items: center;">
                    ...
                    <div style="display: flex;width: 25%;align-content: space-between;align-items: stretch;justify-content: space-between;flex-direction: column;flex-wrap: nowrap;">
                        <label for="dataInizio">Data Inizio:
                            <input type="date" id="dataInizio" name="dataInizio" max="<?= $dataMassima ?>"  min="<?= $dataMinima ?>" value="<?= $dataDefault ?>" onchange="aggiornaMandato()" > 
                        </label>
                        <br>
                        <label for="dataFine">Data  Fine: 
                            <input type="date" id="dataFine" name="datafine" max="<?= $dataMassima ?>"  min="<?= $dataMinima ?>" value="<?= $dataDefault ?>" onchange="aggiornaMandato()">
                        </label>
                    </div>


                    <div style="display: flex;flex-direction: column;">                       
                        <button type="button" onclick="creaTabellaStore();pdpInternoVuoto();pdpEsternoVuoto();">Store</button>
                    </div>
                </div>
            </form>
        </div>
