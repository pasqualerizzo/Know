...
if (in_array("Plenitude", $mandato)) {
    ...
    SUM(IF(DATA BETWEEN '$dataMinore' AND '$dataMaggiore', 1, 0)) AS totaleDataIntervallo,
...
WHERE mese BETWEEN '$dataMinore' AND '$dataMaggiore' AND comodity <> 'Polizza' AND fasePDA = 'OK' AND fasePost = 'KO' and sede = 'Benchmark'
GROUP BY macroStati";
//echo $queryMacroKo ;
