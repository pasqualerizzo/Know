...
//echo $queryCrm;
            break;
            case "Vodafone":
            $queryCrm = ""; // Imposta la query come stringa vuota
            break;

        case "Vivigas Energia":
            $queryCrm = "SELECT "
                    . "statoPda, fasePDA, sum(pezzoLordo) ,SUM(if((data<='$dataMaggiore'and data>='$dataMinore'),pezzoLordo,0)) "
                    . "FROM "
                    . "vivigas "
...
if ($idMandato == 'Plenitude') {
    include "creaTabellaPdpInternoPolizzeSubMandatiDue.php";
}
echo $html;
