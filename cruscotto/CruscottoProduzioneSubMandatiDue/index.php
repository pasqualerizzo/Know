...
<html>
    ...
    <body style="font-family: poppins;" onload="aggiornaMandatoInvertito();permessi()">
        <header>
            <h1>Metrics:Cruscotto Produzione BMP</h1>
        </header>
        ...
        <select size="1" id="sede" multiple disabled>
            <option value="Benchmark" selected>Benchmark</option>
                    ...
                    <div style="display: flex;flex-direction: column;">
                        ...
                        <button type="button" onclick="creaTabellaInvertitoSubMandatiDue();creaTabellaPdpSubMandatiDue();creaTabellaPdpEsternoSubMandatiDue();creaTabellaMatricolaSubMandatiDue()">Aggiorna</button>
