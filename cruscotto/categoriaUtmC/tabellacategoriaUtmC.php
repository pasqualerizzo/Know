...
$query = "SELECT * FROM `categoriaCampagna` order by categoria,utmCampagna asc";
...
<html>
    <head>
        <title>Lead: Categoria UTMC</title>
    ...
    <body>
        <header>
            <h1 class="titolo">Lead:<br>Categoria UTM Campagna</h1>
        </header>
        <div>
...
?>
    ...
    cells.forEach(function(cell) {
        cell.addEventListener('click', function() {
            ...
            window.location.href = 'modificaCategoriaUtmC.php?id=' + id;
        });
    });
});
