...
$queryRicerca = "SELECT "
        ...
        . "date_format(vtiger_enelincf.cf_5797,'%d-%m-%Y') as 'data', "
        . "vtiger_enelincf.cf_5631 as 'comodity', "
        . "'Consumer' as 'Mercato', "
        . "'Rende' as 'Sede', "
        . "vtiger_enelincf.cf_5597 as 'Metodo Pagamento', "
        . "vtiger_enelincf.cf_5599 as 'Metodo Invio', "
        . "vtiger_enelincf.cf_5609 as 'Stato PDA', "
        . "vtiger_enelincf.cf_5621 as 'Stato Luce', "
        . "vtiger_enelincf.cf_5623 as 'Stato Gas', "
        . "'NO' as 'winback', "
        . "entity.createdtime AS 'dataCreazione', "
        . "'EnelIn' as 'Codice Campagna', "
        . "vtiger_enelincf.enelInid AS 'pratica', "
        . "'NO' as 'Sanata BO', "
        . "'NO' as 'assicurazione', "
        . "vtiger_enelincf.cf_5603 as 'fibra', "
        . "'NO' as 'aggiuntivi', "
        . "vtiger_enelincf.cf_5613 as 'idLuce', "
        . "vtiger_enelincf.cf_5615 as 'idGas' "
        . "FROM "
        . "vtiger_enelincf  "
        . "inner join vtiger_enelIn on vtiger_enelincf.enelInid=vtiger_enelIn.enelInid "
        . "inner join vtiger_crmentity as entity on vtiger_enelincf.enelInid=entity.crmid "
        . "inner join vtiger_users as operatore on entity.smownerid=operatore.id "
        . "WHERE "
        . "vtiger_enelincf.cf_5797 >'2023-01-31'";
 ...
 */ else {
    $dataTruncate = truncateEnelIn($conn19);
    ...
    while ($riga = $risultato->fetch_array()) {
         ...
         */
        $idStatoPda = idStatoPdaEnelIn($conn19, $statoPDA);

        /**
         * ricerca id stato luce
         */
        $idStatoLuce = idStatoLuceEnelIn($conn19, $statoLuce);
        /**
         * Ricerca id stato Gas
         */
        $idStatoGas= idStatoGasEnelIn($conn19, $statoGas);
        
        
        if ($winback == "Si") {
            $mandato = "EnelIn Retention";
            $idMandato = 35;
        } else {
            $mandato = "EnelIn";
            $idMandato = 35;
        ...
        $queryCampagna = "SELECT * FROM `enelInCampagna` where nome='$codiceCampagna'";
        $risultatoCampagna = $conn19->query($queryCampagna);
        $conteggioCampagna = $risultatoCampagna->num_rows;
        if ($conteggioCampagna == 0) {
            $queryInserimentoCampagna = "INSERT INTO `enelInCampagna`( `nome`) VALUES ('$codiceCampagna')";
...
//Peso Commodity
        $queryPesoComodity = "SELECT peso FROM `enelInPesiComoditi` WHERE tipoCampagna='$tipoCampagna' AND valore='$comodity' AND dataInizioValidita='$mese'";
        ...
        $queryPesoInvio = "SELECT peso FROM `enelInPesiInvio` WHERE tipoCampagna='$tipoCampagna' AND valore='$metodoInvio' AND dataInizioValidita='$mese'";
        ...
        $queryPesoPagamento = "SELECT peso FROM `enelInPesiMetodoPagamento` WHERE tipoCampagna='$tipoCampagna' AND valore='$metodoPagamento' AND dataInizioValidita='$mese'";
        ...
        $queryPesoAssicurazione = "SELECT peso FROM `enelInPesiAssicurazione` WHERE tipoCampagna='$tipoCampagna' AND valore='$assicurazione' AND dataInizioValidita='$mese'";
        ...
        $queryPesoFibra = "SELECT peso FROM `enelInPesiFibra` WHERE tipoCampagna='$tipoCampagna' AND valore='$fibra' AND dataInizioValidita='$mese'";
        ...
        $queryPesoAggiuntivi = "SELECT peso FROM `enelInPesiAggiuntivi` WHERE tipoCampagna='$tipoCampagna' AND valore='$aggiuntivi' AND dataInizioValidita='$mese'";
...
//echo $queryInserimentoSecondario;
        ...
        aggiornaPesiCrmEnelIn($connCrm, $mese, $pesoTotaleLordo, $pesoTotalePagato, $pratica);
    }
