...
$queryRicerca = "SELECT "
    ...
    . "date_format(irencf.cf_4276,'%d-%m-%Y') as 'data', "
    . "irencf.cf_4278 as 'comodity', "
    . "irencf.cf_4280 as 'Mercato', "
    . "irencf.cf_4282 as 'Sede', "
    . "irencf.cf_4378 as 'Metodo Pagamento', "
    . "irencf.cf_4330 as 'Metodo Invio', "
    . "irencf.cf_4392 as 'Stato PDA', "
    . "irencf.cf_4414 as 'Stato Luce', "
    . "irencf.cf_4412 as 'Stato Gas', "
    . "entity.createdtime AS 'dataCreazione', "
    . "irencf.cf_4284 as 'Codice Campagna', "
    . "irencf.irenid AS 'pratica', "
    . "irencf.cf_4400 AS 'codicePlicoLuce', "
    . "irencf.cf_4402 AS 'codicePlicoGas', "
    . "irencf.cf_4286 AS 'tipo acquisizione', "
    . "irencf.cf_4268 AS 'id gestione lead', "
    . "irencf.cf_4270 AS 'id leadId' "
    . "FROM "
 ...
 */ else {
    ...
    while ($riga = $risultato->fetch_array()) {
        ...
        $comodity = strtolower($riga[2]);
        $mercato = strtolower($riga[3]);
        $sede = $riga[4];
        $metodoPagamento = $riga[5];
        $metodoInvio = $riga[6];
        $statoPDA = $riga[7];
        $statoLuce = strtolower($conn19->real_escape_string($riga[8]));
        $statoGas = strtolower($conn19->real_escape_string($riga[9]));
        $winback = "no";
