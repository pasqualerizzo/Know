...
$queryRicerca = "SELECT "
        ...
        . "enel.enelinid AS 'pratica', "
        . "enel.noteplicoluce AS 'Note Stato Luce', "
        . "enel.noteplicogas AS 'Note Stato Gas' "
        . "FROM "
        . "vtiger_enelincf as enelcf "
        . "inner join vtiger_enelin as enel on enelcf.enelinid=enel.enelinid "
        . "inner join vtiger_crmentity as entity on enel.enelinid=entity.crmid "
 ...
 */ else {
    ...
    while ($riga = $risultato->fetch_array()) {
      ...
      $fasePDA = $arrayStatoPda[$statoPDA][1];
        ...
        $queryInserimento = "INSERT INTO `sincroEnelin`"
