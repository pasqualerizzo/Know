 ...
 */ else {
    ...
    while ($riga = $risultato->fetch_array()) {
        ...
        $noteStatoLuce = $riga[19];
        $noteStatoGas = $riga[20];
        /**
...
//                echo "<br>";
        ...
        if ($faseGas == "OK" && $faseLuce == "OK" && $comodity == "Dual") {
            if ($data >= '2024-05-01' && $metodoPagamento == "Bollettino Postale") {
                $pesoTotaleNetto = 0.4;
            ...
            if ($data >= '2024-05-01' && $metodoPagamento == "Bollettino Postale" && $pesoTotaleLordo >= 0.4) {
                $pesoTotaleNetto = 0.4;
                $pezzoNetto = $pezzoLordo;
            } else {
                $pesoTotaleNetto = $pesoTotaleLordo;
