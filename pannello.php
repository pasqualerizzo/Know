...
if ($logged == false) {
    header("location:index.php?errore=logged");
}

$queryMese = "SELECT mese FROM `stringheTotale` group by mese order by giorno";
...
<html>
    ...
    <body style="font-family: poppins;" onload="permessi()">
        <header>
            ...
            <h2>Benvenuto <?= $user ?> <?= $visualizzazione ?></h2>
        </header>
        <?php include 'elementi/sidebar.html' ?>
        <div>
            <input type="hidden"  id="permessi" value=<?= $visualizzazione ?>>
        </div>
        <div id="main">
            <div class="pagina" id="pulsantiera">
                ...
                <button onclick="aggiornaIren()">Aggiorna Iren</button>
                <button onclick="aggiornaUnion()">Aggiorna Union</button>
                <br>
                <div>
    ...
    <script>
        ...
        function aggiornaPlenitude() {
            window.location.href = "./crm/plenitudeArray.php";
        }
        ...
        function aggiornaIren() {
            window.location.href = "./crm/iren.php";
        }
         function aggiornaUnion() {
            window.location.href = "./crm/union.php";
        }
        function scaricaCSV() {
