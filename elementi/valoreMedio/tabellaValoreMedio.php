...
$queryMese = "SELECT mese FROM `mediaPraticaMese` GROUP by mese ORDER by mese DESC";
...
$query = "SELECT * FROM `mediaPraticaMese` where mese='$meseSelezionato' order by mandato,media";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Valore Medio</h1>
...
?>
    ...
    <script>
        ...
        function redirigi(sel) {
            ...
            window.location.href = "tabellaValoreMedio.php?meseSelezionato=" + data;
...
function editRow(button) {
    ...
    window.location.href = 'modificaValoreMedio.php?id=' + id;
        }

        function aggiungiMese() {

            window.location.href = "aggiungiMeseValoreMedio.php";
        }
  function aggiungiRiga() {
            window.location.href = "aggiungiValoreMedio.php";
        }
