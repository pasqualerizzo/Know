...
$queryMese = "SELECT dataInizioValidita FROM `timPesiMetodoPagamento` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `timPesiMetodoPagamento` where dataInizioValidita='$meseSelezionato'";
...
<body>
<header>
    <h1 class="titolo">Tim:<br>Pesi Pagamento</h1>
</header>
<div>
