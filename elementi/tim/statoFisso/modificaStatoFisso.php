...
$query = "SELECT * FROM `timStatoFisso` where id='$id'";
...
<body>
<header>
    <h1 class="titolo">Tim:<br>Mod. Stato Gas</h1>
</header>
<div>
...
<div class="pagina">
    <form action="queryModificaStatoFisso.php" method="POST">
        <fieldset>
            ...
            <input type="button" value="Elimina" onclick="location.href='queryEliminaStatoFisso.php?id='+<?= $id ?>;">
        </fieldset>
    </form>
