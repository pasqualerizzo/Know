...
$queryMese = "SELECT dataInizioValidita FROM `timPesiComoditi` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `timPesiComoditi` where dataInizioValidita='$meseSelezionato' order by tipoAcquisizione, tipoCampagna,valore";
...
<body>
<header>
    <h1 class="titolo">Tim:<br>Pesi Comodity</h1>
