...
$query = "SELECT * FROM `tim` inner join aggiuntaTim on tim.id=aggiuntaTim.id where mese='$meseSelezionato'";
...
<html>
<head>
    <title>MagePunti: Tim Group</title>
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaTim.php?meseSelezionato=" + data;
    ...
    function scaricaCSV() {
        ...
        console.log(valore);
        window.location.href = "exportTabellaTim.php?meseSelezionato=" + valore;
    }
</script>
</html>
