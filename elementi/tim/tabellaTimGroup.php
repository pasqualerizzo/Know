...
$queryMese = "SELECT mese FROM aggiuntaTim group by mese ORDER by mese DESC";
...
$query = "SELECT creatoDa,round(sum(pesoTotaleLordo),5) as 'Peso Lordo' ,round(sum(pesoPagato),5)as 'Peso Pagato'  FROM `tim` inner join aggiuntaTim on tim.id=aggiuntaTim.id where mese='$meseSelezionato' group by creatoDa";
...
<body>
<header>
    <h1 class="titolo">Tim:<br>per Operatore</h1>
</header>
<div>
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaTimGroup.php?meseSelezionato=" + data;
    ...
    function scaricaCSV() {
        ...
        window.location.href = "exportTabellaTimGroup.php?meseSelezionato=" + valore;
    }
</script>
</html>
