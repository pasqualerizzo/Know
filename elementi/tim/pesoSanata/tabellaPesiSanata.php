...
$queryMese = "SELECT dataInizioValidita FROM `timPesiSanata` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `timPesiSanata` where dataInizioValidita='$meseSelezionato'";
...
<body>
<header>
    <h1 class="titolo">Tim:<br>Pesi Sanata</h1>
</header>
<div>
