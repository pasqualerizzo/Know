...
$query = "SELECT * FROM `timStatoMobile` where id='$id'";
...
<body>
<header>
    <h1 class="titolo">Tim:<br>Mod Stato Mobile</h1>
</header>
<div>
...
<div class="pagina">
    <form action="queryModificaStatoMobile.php" method="POST">
        <fieldset>
            <legend>Modifica Stato Mobile</legend>
            ...
            <select id="fase" name="fase">
                <option value="" <?php if ($riga[2] == "") {
                    echo "selected";
                } ?>>-
                </option>
                <option value="OK" <?php if ($riga[2] == "OK") {
                    echo "selected";
                } ?>>OK
                </option>
                <option value="KO" <?php if ($riga[2] == "KO") {
                    echo "selected";
                } ?>>KO
                </option>
                <option value="BKL" <?php if ($riga[2] == "BKL") {
                    echo "selected";
                } ?>>BKL
                </option>
                <option value="BKLP" <?php if ($riga[2] == "BKLP") {
                    echo "selected";
                } ?>>BKLP
                </option>
                <?= $riga[2] ?>
            ...
            <input type="button" value="Elimina" onclick="location.href='queryEliminaStatoMobile.php?id='+<?= $id ?>;">
        </fieldset>
    </form>
