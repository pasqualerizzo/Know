...
$query = "SELECT * FROM `timStatoPDA` where id='$id'";
...
<body>
<header>
    <h1 class="titolo">Tim:<br>Mod. Stato PDA</h1>
</header>
<div>
...
<div class="pagina">
    <form action="queryModificaStatoPda.php" method="POST">
        <fieldset>
            ...
            <input type="button" value="Elimina" onclick="location.href='queryEliminaStatoPda.php?id='+<?= $id ?>;">
        </fieldset>
    </form>
