...
$queryMese = "SELECT dataInizioValidita FROM `timPesiInvio` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `timPesiInvio` where dataInizioValidita='$meseSelezionato'";
...
<body>
<header>
    <h1 class="titolo">Tim:<br>Pesi Invio</h1>
</header>
<div>
