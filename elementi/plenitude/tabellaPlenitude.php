...
$query = "SELECT * FROM `plenitude` inner join aggiuntaPlenitude on plenitude.id=aggiuntaPlenitude.id where mese='$meseSelezionato'";
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaPlenitude.php?meseSelezionato=" + data;
    ...
    function scaricaCSV() {
        ...
        window.location.href = "exportTabellaPlenitude.php?meseSelezionato=" + valore;
    }
</script>
</html>
