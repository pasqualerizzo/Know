...
$queryMese = "SELECT dataInizioValidita FROM `plenitudePesiInvio` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `plenitudePesiInvio` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Plenitude:<br>Pesi Invio</h1>
        </header>
        <div>
