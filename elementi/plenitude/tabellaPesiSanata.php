...
$queryMese = "SELECT dataInizioValidita FROM `plenitudePesiSanata` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `plenitudePesiSanata` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Plenitude:<br>Pesi Sanata</h1>
        </header>
        <div>
