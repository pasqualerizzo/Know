...
$queryMese = "SELECT dataInizioValidita FROM `plenitudePesiComoditi` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `plenitudePesiComoditi` where dataInizioValidita='$meseSelezionato' order by tipoAcquisizione, tipoCampagna,valore";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Plenitude:<br>Pesi Comodity</h1>
