...
$queryMese = "SELECT dataInizioValidita FROM `plenitudePesiMetodoPagamento` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `plenitudePesiMetodoPagamento` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Plenitude:<br>Pesi Pagamento</h1>
        </header>
        <div>
