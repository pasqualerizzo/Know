...
$queryMese = "SELECT mese FROM `obbiettivoTL` GROUP by mese ORDER by mese DESC";
...
$query = "SELECT * FROM `obbiettivoTL` where mese='$meseSelezionato' order by gruppoTL,tipo";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Obbiettito TL</h1>
...
function editRow(button) {
    ...
    window.location.href = 'modificaObbiettivoTL.php?id=' + id;
        }

        function aggiungiMese() {
            window.location.href = "aggiungiMeseObbiettivoTL.php";
        }
  function aggiungiRiga() {
            window.location.href = "aggiungiObbiettivoTL.php";
        }
