...
$queryMese = "SELECT dataInizioValidita FROM `heracomPesiInvio` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `heracomPesiInvio` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Heracom:<br>Pesi Invio</h1>
        </header>
        <div>
...
function redirigi(sel) {
 ...
 function editRow(button) {
    ...
    window.location.href = 'modificaPesiInvio.php?id=' + id;
        }
    </script>
</html>
