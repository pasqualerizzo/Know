...
$queryMese = "SELECT dataInizioValidita FROM `heracomPesiMetodoPagamento` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `heracomPesiMetodoPagamento` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Heracom:<br>Pesi Pagamento</h1>
        </header>
        <div>
