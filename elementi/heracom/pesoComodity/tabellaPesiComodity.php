...
$queryMese = "SELECT dataInizioValidita FROM `heracomPesiComoditi` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `heracomPesiComoditi` where dataInizioValidita='$meseSelezionato' order by  tipoCampagna,valore";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Heracom:<br>Pesi Comodity</h1>
