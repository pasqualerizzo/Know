...
$queryMese = "SELECT dataInizioValidita FROM `heracomPesiSanata` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `heracomPesiSanata` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Heracom:<br>Pesi Sanata</h1>
        </header>
        <div>
