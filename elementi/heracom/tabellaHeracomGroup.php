...
$queryMese = "SELECT mese FROM aggiuntaHeracom group by mese ORDER by mese DESC";
...
$query = "SELECT assegnato,round(sum(totalePesoLordo),5) as 'Peso Lordo' ,round(sum(pesoTotalePagato),5)as 'Peso Pagato'  FROM `heracom` inner join aggiuntaHeracom on heracom.id=aggiuntaHeracom.id where mese='$meseSelezionato' group by assegnato";
...
<html>
<head>
    <title>MagePunti: Heracom Group</title>
...
<body>
<header>
    <h1 class="titolo">Heracom:<br>per Operatore</h1>
</header>
<div>
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaHeracomGroup.php?meseSelezionato=" + data;
    ...
    function scaricaCSV() {
        ...
        window.location.href = "exportTabellaHeracomGroup.php?meseSelezionato=" + valore;
    }
</script>
</html>
