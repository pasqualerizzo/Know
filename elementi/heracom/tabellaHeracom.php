...
$query = "SELECT * FROM `heracom` inner join aggiuntaHeracom on heracom.id=aggiuntaHeracom.id where mese='$meseSelezionato'";
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaHeracom.php?meseSelezionato=" + data;
    ...
    function scaricaCSV() {
        ...
        window.location.href = "exportTabellaHeracom.php?meseSelezionato=" + valore;
    }
</script>
</html>
