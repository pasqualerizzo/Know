...
$queryMese = "SELECT mese FROM `tabellaCosti` GROUP by mese ORDER by mese DESC";
...
$query = "SELECT * FROM `tabellaCosti` where mese='$meseSelezionato' order by sede";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Tabella Costi</h1>
