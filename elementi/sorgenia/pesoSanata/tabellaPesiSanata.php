...
$queryMese = "SELECT dataInizioValidita FROM `sorgeniaPesiSanata` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `sorgeniaPesiSanata` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Sorgenia:<br>Pesi Sanata</h1>
        </header>
        <div>
