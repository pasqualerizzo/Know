...
$query = "SELECT * FROM `sorgenia` inner join aggiuntaSorgenia on sorgenia.id=aggiuntaSorgenia.id where mese='$meseSelezionato'";
...
<html>
    <head>
        <title>MagePunti: Sorgenia Group</title>
    ...
    <script>
        ...
        function redirigi(sel) {
            ...
            window.location.href = "tabellaEnel.php?meseSelezionato=" + data;

        }


        function scaricaCSV() {
            var valore =<?php echo "'$meseSelezionato'"?>;
            console.log(valore);
            window.location.href = "exportTabellaSorgenia.php?meseSelezionato=" + valore;
        }
    </script>
</html>
