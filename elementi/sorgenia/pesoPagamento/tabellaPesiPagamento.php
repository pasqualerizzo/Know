...
$queryMese = "SELECT dataInizioValidita FROM `sorgeniaPesiMetodoPagamento` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `sorgeniaPesiMetodoPagamento` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Sorgenia:<br>Pesi Pagamento</h1>
        </header>
        <div>
