...
$queryMese = "SELECT dataInizioValidita FROM `sorgeniaPesiInvio` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `sorgeniaPesiInvio` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Sorgenia:<br>Pesi Invio</h1>
        </header>
        <div>
