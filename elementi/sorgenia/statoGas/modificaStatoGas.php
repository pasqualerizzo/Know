...
$query = "SELECT * FROM `sorgeniaStatoGas` where id='$id'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Sorgenia:<br>Mod. Stato Gas</h1>
        </header>
        <div>
...
<?php include '/Applications/MAMP/htdocs/Know/elementi/sidebar.html' ?>
        <div class="pagina">
            <form action="queryModificaStatoGas.php" method="POST">
                <fieldset>
                    <legend>Modifica Stato Gas</legend>
...
<?= $riga[2] ?>
                    ...
                    <input type="button" value="Elimina" onclick="location.href='queryEliminaStatoGas.php?id='+<?= $id ?>;">
                </fieldset>
            </form>
