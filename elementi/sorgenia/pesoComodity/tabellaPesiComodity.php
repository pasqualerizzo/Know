...
$queryMese = "SELECT dataInizioValidita FROM `sorgeniaPesiComoditi` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `sorgeniaPesiComoditi` where dataInizioValidita='$meseSelezionato' order by tipoAcquisizione, tipoCampagna,valore";
...
<html>
    <head>
        <title>Metrics: Sorgenia Group</title>
    ...
    <body>
        <header>
            <h1 class="titolo">Sorgenia:<br>Pesi Comodity</h1>
