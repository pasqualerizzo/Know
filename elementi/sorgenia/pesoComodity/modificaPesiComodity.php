...
$query = "SELECT * FROM sorgeniaPesiComoditi where id='$id'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Sorgenia:<br>Mod. p.Comodity</h1>
        </header>
        <div>
        ...
        <div class="pagina">
            <form action="queryModificaPesiComodity.php" method="POST">
                <fieldset>
                    ...
                    <br>
                    <label for="tipoAcquisizione">tipo Acquisizione
                        <input type="text" name="tipoCampagna" readonly value=<?=$riga[2]?>>
                    </label>
