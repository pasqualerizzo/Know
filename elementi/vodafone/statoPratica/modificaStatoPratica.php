...
$query = "SELECT * FROM `vodafoneStatoPratica` where id='$id'";
...
<html>
   <head>
    ...
    <body>
        <header>
            <h1 class="titolo">Vodafone:<br>Mod. Stato Pratica</h1>
        </header>
         <div>
        ...
        <div class="pagina">
            <form action="queryModificaStatoPratica.php" method="POST">
                <fieldset>
                    <legend>Modifica Stato Pratica</legend>
                    ...
                    <input type="button" value="Elimina" onclick="location.href='queryEliminaStatoPratica.php?id='+<?=$id?>;">
                </fieldset>
            </form>
