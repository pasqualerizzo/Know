...
$query = "SELECT * FROM `vodafonePesiOpzioni` where id='$id'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Vodefone:<br>Mod. p.Opzioni</h1>
        </header>
         <div>
...
<?php include '/Applications/MAMP/htdocs/Know/elementi/sidebar.html' ?>
        <div class="pagina">
            <form action="queryModificaPesiOpzioni.php" method="POST">
                <fieldset>
                    <legend>Modifica Peso Piano</legend>
