...
$queryMese = "SELECT dataInizioValidita FROM `vodafonePesiOpzioni` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `vodafonePesiOpzioni` where dataInizioValidita='$meseSelezionato'";
...
<html>
   <head>
    ...
    <body>
        <header>
            <h1 class="titolo">Vodafone: <br>Pesi opzione</h1>
    ...
    <script>
        ...
        function redirigi(sel) {
            ...
            window.location.href = "tabellaPesiOpzioni.php?meseSelezionato=" + data;
        ...
        function aggiungiMese() {
            ...
            window.location.href = "aggiungiMesePesoOpzioni.php";
        }
    ...
    window.location.href = 'modificaPesiOpzioni.php?id=' + id;
