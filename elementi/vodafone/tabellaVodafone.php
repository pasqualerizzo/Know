...
$query = "SELECT * FROM `vodafone` inner join aggiuntaVodafone on vodafone.id=aggiuntaVodafone.id where mese='$meseSelezionato'";
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaVodafone.php?meseSelezionato=" + data;
    ...
    function scaricaCSV() {
        ...
        window.location.href = "exportTabellaVodafone.php?meseSelezionato=" + valore;
    }
</script>
</html>
