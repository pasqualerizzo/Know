...
$query = "SELECT * FROM `vodafonePesiMobile` where id='$id'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Vodefone:<br>Mod. p.Mobile</h1>
        </header>
         <div>
...
<?php include '/Applications/MAMP/htdocs/Know/elementi/sidebar.html' ?>
        <div class="pagina">
            <form action="queryModificaPesiMobile.php" method="POST">
                <fieldset>
                    <legend>Modifica Peso Mobile</legend>
