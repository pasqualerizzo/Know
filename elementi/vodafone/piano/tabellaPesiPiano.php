...
$queryMese = "SELECT dataInizioValidita FROM `vodafonePesiPiano` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `vodafonePesiPiano` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <script>
        ...
        function redirigi(sel) {
            ...
            window.location.href = "tabellaPesiPiano.php?meseSelezionato=" + data;
        ...
        function aggiungiMese() {
            ...
            window.location.href = "aggiungiMesePesoPiano.php";
        }
    ...
    window.location.href = 'modificaPesiPiano.php?id=' + id;
