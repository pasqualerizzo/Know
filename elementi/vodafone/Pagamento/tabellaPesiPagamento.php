...
$queryMese = "SELECT dataInizioValidita FROM `vodafonePesiPagamento` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `vodafonePesiPagamento` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Vodafone: <br>Pesi Pagamento</h1>
