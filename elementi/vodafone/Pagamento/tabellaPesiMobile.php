...
$queryMese = "SELECT dataInizioValidita FROM `vodafonePesiMobile` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `vodafonePesiMobile` where dataInizioValidita='$meseSelezionato'";
...
<html>
   <head>
    ...
    <body>
        <header>
            <h1 class="titolo">Vodafone: <br>Pesi Mobile</h1>
    ...
    <script>
        ...
        function redirigi(sel) {
            ...
            window.location.href = "tabellaPesiOMobile.php?meseSelezionato=" + data;
        ...
        function aggiungiMese() {
            ...
            window.location.href = "aggiungiMesePesoMobile.php";
        }
        ...
        $(function () {
            $('#pesi td').on('click', function () {
                ...
                window.location.href = 'modificaPesiMobile.php?id=' + id;
            });
        });
    </script>
</html>
