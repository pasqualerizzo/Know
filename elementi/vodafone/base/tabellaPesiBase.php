...
$queryMese = "SELECT dataInizioValidita FROM `vodafonePesiBase` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `vodafonePesiBase` where dataInizioValidita='$meseSelezionato'";
...
<html>
   <head>
    ...
    <body>
        <header>
            <h1 class="titolo">Vodafone: <br>Pesi Base</h1>
...
?>
    ...
    <script>
        ...
        function redirigi(sel) {
            ...
            window.location.href = "tabellaPesiBase.php?meseSelezionato=" + data;
        ...
        function aggiungiMese() {
            ...
            window.location.href = "aggiungiMesePesoBase.php";
        }
    ...
    window.location.href = 'modificaPesiBase.php?id=' + id;
