...
$query = "SELECT * FROM `vodafonePesiBase` where id='$id'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Vodefone:<br>Mod. p.Base</h1>
        </header>
         <div>
...
<?php include '/Applications/MAMP/htdocs/Know/elementi/sidebar.html' ?>
        <div class="pagina">
            <form action="queryModificaPesiBase.php" method="POST">
                <fieldset>
                    <legend>Modifica Peso Base</legend>
