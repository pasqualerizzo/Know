...
$queryMese = "SELECT mese FROM `tabellaCostiMessaggi` GROUP by mese ORDER by mese DESC";
...
$query = "SELECT * FROM `tabellaCostiMessaggi` where mese='$meseSelezionato' order by UTM";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Tabella Costi Messaggi</h1>
...
<?php include '/Applications/MAMP/htdocs/Know/elementi/sidebar.html' ?>
        <div class="pagina">
            <div>
                ...
                <button onclick="aggiungiRiga()">Aggiungi Invio SMS</button>
            </div>
            <div>
...
?>
    ...
    <script>
        ...
        function redirigi(sel) {
            ...
            window.location.href = "index.php?meseSelezionato=" + data;
        }
...
function editRow(button) {
    ...
    window.location.href = 'modificaTabellaCosti.php?id=' + id;
        }

        function aggiungiMese() {
            window.location.href = "aggiungiMeseTabellaCosti.php";
        }
  function aggiungiRiga() {
            window.location.href = "aggiungiTabellaCosti.php";
        }
