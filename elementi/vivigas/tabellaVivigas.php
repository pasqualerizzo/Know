...
<div class="pagina">
    ...
    <div style="overflow-x: visible">
        <table class='blueTable' style="overflow: visible">
            <thead>
            <tr>
                <?php
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaVivigas.php?meseSelezionato=" + data;
    ...
    function scaricaCSV() {
        ...
        window.location.href = "exportTabellaVivigas.php?meseSelezionato=" + valore;
    }
