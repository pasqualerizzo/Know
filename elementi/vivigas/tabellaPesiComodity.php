...
$queryMese = "SELECT dataInizioValidita FROM `vivigasPesiComoditi` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `vivigasPesiComoditi` where dataInizioValidita='$meseSelezionato'";
...
<html>
<head>
    <title>MagePunti: Vivigas Pesi Comodity</title>
...
<body>
<header>
    <h1 class="titolo">Vivigas:<br>Pesi Comodity</h1>
</header>
<div>
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaPesiComodity.php?meseSelezionato=" + data;
    ...
    function aggiungiMese() {
        ...
        window.location.href = "aggiungiMesePesoComodity.php";
    }
    ...
    function editRow(button) {
        ...
        window.location.href = 'modificaPesiComodity.php?id=' + id;
