...
$queryMese = "SELECT dataInizioValidita FROM `vivigasPesiInvio` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `vivigasPesiInvio` where dataInizioValidita='$meseSelezionato'";
...
<html>
<head>
    <title>MagePunti: Vivigas Pesi Invio</title>
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaPesiInvio.php?meseSelezionato=" + data;
    ...
    function aggiungiMese() {
        ...
        window.location.href = "aggiungiMesePesoInvio.php";
    }
