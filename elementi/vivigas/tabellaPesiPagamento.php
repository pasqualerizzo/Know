...
$queryMese = "SELECT dataInizioValidita FROM `vivigasPesiMetodoPagamento` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `vivigasPesiMetodoPagamento` where dataInizioValidita='$meseSelezionato'";
...
<html>
<head>
    <title>MagePunti: Vivigas pesi Pagamento</title>
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaPesiPagamento.php?meseSelezionato=" + data;
    ...
    function scaricaCSV() {
        ...
        window.location.href = "exportTabellaVivigasGroup.php?meseSelezionato=" + valore;
    }

    function aggiungiMese() {

        window.location.href = "aggiungiMesePesoPagamento.php";
    }
    ...
    function editRow(button) {
        ...
        window.location.href = 'modificaPesiPagamento.php?id=' + id;
