...
$queryMese = "SELECT dataInizioValidita FROM `vivigasPesiSanata` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `vivigasPesiSanata` where dataInizioValidita='$meseSelezionato'";
...
<html>
<head>
    <title>MagePunti: Vivigas pesi Sanata</title>
...
<script>
    ...
    function aggiungiMese() {
        ...
        window.location.href = "aggiungiMesePesoSanata.php";
    }
    ...
    function editRow(button) {
        ...
        window.location.href = 'modificaPesiSanata.php?id=' + id;
