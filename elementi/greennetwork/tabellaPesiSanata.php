...
$queryMese = "SELECT dataInizioValidita FROM `greenPesiSanata` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `greenPesiSanata` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Green Network:<br>Pesi Sanata</h1>
        </header>
        <div>
