...
$queryMese = "SELECT dataInizioValidita FROM `greenPesiComoditi` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `greenPesiComoditi` where dataInizioValidita='$meseSelezionato'";
...
<body>
<header>
    <h1 class="titolo">Green Network: <br>Pesi Comodity</h1>
