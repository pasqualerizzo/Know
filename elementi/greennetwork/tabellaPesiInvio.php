...
$queryMese = "SELECT dataInizioValidita FROM `greenPesiInvio` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `greenPesiInvio` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Green Network:<br>Pesi Invio</h1>
        </header>
        <div>
