...
$queryMese = "SELECT dataInizioValidita FROM `greenPesiMetodoPagamento` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `greenPesiMetodoPagamento` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Green Network:<br>Pesi Pagamento</h1>
        </header>
        <div>
