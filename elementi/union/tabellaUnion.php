...
$query = "SELECT * FROM `union` inner join aggiuntaUnion on union.id=aggiuntaUnion.id where mese='$meseSelezionato'";
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaUnion.php?meseSelezionato=" + data;
    ...
    function scaricaCSV() {
        ...
        window.location.href = "exportTabellaUnion.php?meseSelezionato=" + valore;
    }
</script>
</html>
