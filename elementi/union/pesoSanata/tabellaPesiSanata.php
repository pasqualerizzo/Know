...
$queryMese = "SELECT dataInizioValidita FROM `unionPesiSanata` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `unionPesiSanata` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Union:<br>Pesi Sanata</h1>
        </header>
        <div>
