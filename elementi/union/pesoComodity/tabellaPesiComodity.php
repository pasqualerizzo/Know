...
$queryMese = "SELECT dataInizioValidita FROM `unionPesiComoditi` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `unionPesiComoditi` where dataInizioValidita='$meseSelezionato' order by tipoAcquisizione, tipoCampagna,valore";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Union:<br>Pesi Comodity</h1>
