...
$queryMese = "SELECT mese FROM aggiuntaUnion group by mese ORDER by mese DESC";
...
$query = "SELECT creatoDa,round(sum(totalePesoLordo),5) as 'Peso Lordo' ,round(sum(pesoTotalePagato),5)as 'Peso Pagato'  FROM `union` inner join aggiuntaUnion on union.id=aggiuntaUnion.id where mese='$meseSelezionato' group by creatoDa";
...
<body>
<header>
    <h1 class="titolo">Union:<br>per Operatore</h1>
</header>
<div>
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaUnionGroup.php?meseSelezionato=" + data;
    ...
    function scaricaCSV() {
        ...
        window.location.href = "exportTabellaUnionGroup.php?meseSelezionato=" + valore;
    }
</script>
</html>
