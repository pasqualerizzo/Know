...
$queryMese = "SELECT dataInizioValidita FROM `irenPesiMetodoPagamento` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `irenPesiMetodoPagamento` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Iren:<br>Pesi Pagamento</h1>
        </header>
        <div>
