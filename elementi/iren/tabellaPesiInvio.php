...
$queryMese = "SELECT dataInizioValidita FROM `irenPesiInvio` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `irenPesiInvio` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Iren:<br>Pesi Invio</h1>
        </header>
        <div>
