...
$queryMese = "SELECT mese FROM aggiuntaIren group by mese ORDER by mese DESC";
...
$query = "SELECT creatoDa,round(sum(totalePesoLordo),5) as 'Peso Lordo' ,round(sum(pesoTotalePagato),5)as 'Peso Pagato'  FROM `iren` inner join aggiuntaIren on iren.id=aggiuntaIren.id where mese='$meseSelezionato' group by creatoDa";
...
<body>
<header>
    <h1 class="titolo">Iren:<br>per Operatore</h1>
</header>
<div>
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaIrenGroup.php?meseSelezionato=" + data;
    ...
    function scaricaCSV() {
        ...
        window.location.href = "exportTabellaIrenGroup.php?meseSelezionato=" + valore;
    }
</script>
</html>
