...
$queryMese = "SELECT dataInizioValidita FROM `irenPesiSanata` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `irenPesiSanata` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Iren:<br>Pesi Sanata</h1>
        </header>
        <div>
