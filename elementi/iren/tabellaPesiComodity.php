...
$queryMese = "SELECT dataInizioValidita FROM `irenPesiComoditi` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `irenPesiComoditi` where dataInizioValidita='$meseSelezionato' order by tipoAcquisizione, tipoCampagna,valore";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Iren:<br>Pesi Comodity</h1>
