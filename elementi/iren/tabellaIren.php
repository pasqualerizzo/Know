...
$query = "SELECT * FROM `iren` inner join aggiuntaIren on iren.id=aggiuntaIren.id where mese='$meseSelezionato'";
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaIren.php?meseSelezionato=" + data;
    ...
    function scaricaCSV() {
        ...
        window.location.href = "exportTabellaIren.php?meseSelezionato=" + valore;
    }
</script>
</html>
