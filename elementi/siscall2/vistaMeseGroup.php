...
$queryMese = "SELECT mese FROM `stringheSiscall2` group by mese";
...
$query = "SELECT user,nomeCompleto,sede,userGroup,mandato,SUM(pause),SUM(wait),SUM(talk),SUM(dispo),SUM(numero),Sum(dead) FROM `stringheSiscall2`where mese='$meseSelezionato' group by user";
