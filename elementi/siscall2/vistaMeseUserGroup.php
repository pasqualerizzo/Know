...
$query = "SELECT userGroup,mandato,SUM(pause),SUM(wait),SUM(talk),SUM(dispo),SUM(numero),Sum(dead) FROM `stringheSiscall2`where mese='$meseSelezionato' group by userGroup";
