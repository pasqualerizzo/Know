...
$queryMese = "SELECT mese FROM `garaOre` GROUP by mese ORDER by mese DESC";
...
$query = "SELECT * FROM `garaOre` where mese='$meseSelezionato' order by nome, fascia";
...
<html>
    ...
    <script>
        ...
        function redirigi(sel) {
            ...
            window.location.href = "tabellaGaraOre.php?meseSelezionato=" + data;

        }
        
        function aggiungiMese() {
            window.location.href = "query/aggiungiMeseGaraOre.php";
        }
         function aggiungiRiga() {
             
            window.location.href = "inserisciGaraOre.php";
        }
    ...
    window.location.href = 'modificaGaraOre.php?id=' + id;
        }
