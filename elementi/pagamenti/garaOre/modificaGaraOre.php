        ...
        <div class="pagina">
            <form action="query/queryModificaGaraOre.php" method="POST">
                <fieldset>
                    ...
                    <input type="text" name="nome" readonly value=<?=$riga[1]?>>
                    
                    <label for="fascia">Fascia</label>
                    <input type="text" name="fascia" readonly value=<?=$riga[2]?>>
                    <br>
                    <label for="data">Mese</label>
                    <input type="text" name="data" readonly value=<?=$riga[3]?>>
                    <br>
                    <label for="pezziMinimi">Pezzi Minimi
                        <input type="number"  min="0" max="1000" step="0.1 "name="pezziMinimi"  value=<?=$riga[4]?>>
                    </label>
                    <label for="pezziMassimi">Pezzi Massimi
                        <input type="number"  min="0" max="1000" step="0.1 "name="pezziMassimi"  value=<?=$riga[5]?>>
                    </label>
                    <br>
                    <label for="oreMinimi">Ore Minime
                        <input type="number"  min="0" max="1000" step="0.1 "name="oreMinime"  value=<?=$riga[6]?>>
                    </label>
                    <br>
                      <label for="oreAutorizzate">Ore Autorizzate
                        <input type="number"  min="0" max="1000" step="0.1 "name="oreAutorizzate"  value=<?=$riga[7]?>>
                    </label>
                    <br>
                    <label for="valore">Valore</label>
                    <input type="number" name="valore" min="0" max="1000" step="0.1"  value=<?=$riga[8]?>>
                    <br>
