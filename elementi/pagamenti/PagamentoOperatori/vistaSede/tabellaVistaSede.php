...
$query = "SELECT "
        ...
        . " livello,"
        . " sede,"
        . " round((numero)+(orePolizze)-formazione,2) as 'Ore Fatte', "
        . " orePagabili as 'Ore Pagabili',"
        . " oreAutorizzate as 'Ore Autorizzate',"
        . " round(vodafonePesoPagato+vivigasPesoPagato+plenitudePesoPagato+greenPesoPagato+enelOutPesoPagato+irenPesoPagato+unionPesoPagato,2) as 'Peso Pagato',"
        . " round(vodafonePesoFormazione+vivigasPesoFormazione+plenitudePesoFormazione+greenPesoFormazione+enelOutPesoFormazione+irenPesoFormazione+unionPesoFormazione,2) as 'Peso Formazione',"
        ...
        . " costoGiorni as 'Costo Giornaliero Risorsa',"
        . " costoAzienda as 'Costo Azienda(1.4)'"
        . " FROM "
        . " pagamentoMese "
