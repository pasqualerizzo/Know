...
<?php include '/Applications/MAMP/htdocs/Know/elementi/sidebar.html' ?>
        <div class="pagina">
            <form action="query/queryInsersciRigaGaraPunti.php" method="POST">
                <fieldset>
                    ...
                    <br>
                    <label for="mese">Mese
                        <input type='date' name="mese" >
                    </label>
                    <br>
                    <label for="puntiMinimi">Punti Minimi</label>
                    <input type="number" name="puntiMinimi" min="0" max="100" step="0.1" >
                    
                    <label for="puntiMassimi">Punti Massimi</label>
                    <input type="number" name="puntiMassimi" min="0" max="1000" step="0.1"  > 
                    <br> 
                    <label for="valore">Valore</label>
                    <input type="number" name="valore" min="0" max="100" step="0.1"   >
