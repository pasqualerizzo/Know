...
while ($riga = $risultato->fetch_array()) {
    ...
    $query = "INSERT INTO `garaOre`(`mese`,  `nome`, `fascia`, `valore`,pezziMinimi,pezziMassimi,oreMinimi,oreAutorizzate ) VALUES ('$meseNuovo','$nome','$fascia','$valore','$pezziMinimi','$pezziMassimi','$oreMinime','$oreAutorizzate')";
    $conn19->query($query);
}
