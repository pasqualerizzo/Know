...
$query = "SELECT * FROM `enelOutPesiComoditi` where id='$id'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Enel Out:<br>Mod. p.Comodity</h1>
        </header>
        <div>
        ...
        <div class="pagina">
            <form action="queryModificaPesiComodity.php" method="POST">
                <fieldset>
                    ...
                    <input type="text" name="valore" readonly value=<?php echo "'".$riga[4]."'" ?> >
