...
$query = "SELECT * FROM `enelOutPesiAssicurazione` where id='$id'";
...
<html>
   <head>
    ...
    <body>
        <header>
            <h1 class="titolo">Enel Out:<br>Mod P. Assicurazione</h1>
        </header>
        <div>
...
<?php include '/Applications/MAMP/htdocs/Know/elementi/sidebar.html' ?>
        <div class="pagina">
            <form action="queryModificaPesiAssicurazione.php" method="POST">
                <fieldset>
