...
$queryMese = "SELECT dataInizioValidita FROM `enelOutPesiAssicurazione` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `enelOutPesiAssicurazione` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Enel Out:<br>Pesi Assicurazione</h1>
        </header>
        <div>
    ...
    <script>
        ...
        function aggiungiMese() {
            ...
            window.location.href = "aggiungiMesePesoAssicurazione.php";
        }
        
          function redirigi(sel) {
            var data = sel.options[sel.selectedIndex].value;
            window.location.href = "tabellaPesiAssicurazione.php?meseSelezionato=" + data;
        ...
        $(function () {
            $('#pesi td').on('click', function () {
                ...
                window.location.href = 'modificaPesiAssicurazione.php?id=' + id;
            });
        });
    </script>
</html>
