...
$query = "SELECT * FROM `enelOutPesiAggiuntivi` where id='$id'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Enel Out:<br>Mod P. Aggiuntivi</h1>
        </header>
        <div>
...
<?php include '/Applications/MAMP/htdocs/Know/elementi/sidebar.html' ?>
        <div class="pagina">
            <form action="queryModificaPesiAggiuntivi.php" method="POST">
                <fieldset>
