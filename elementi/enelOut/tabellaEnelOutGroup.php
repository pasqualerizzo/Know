...
$queryMese = "SELECT mese FROM aggiuntaEnelOut group by mese ORDER by mese DESC";
...
$query = "SELECT creatoDa,round(sum(totalePesoLordo),5) as 'Peso Lordo' ,round(sum(pesoTotalePagato),5)as 'Peso Pagato'  FROM `enelOut` inner join aggiuntaEnelOut on enelOut.id=aggiuntaEnelOut.id where mese='$meseSelezionato' group by creatoDa";
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaEnelOutGroup.php?meseSelezionato=" + data;
    ...
    function scaricaCSV() {
        ...
        window.location.href = "exportTabellaEnelOutGroup.php?meseSelezionato=" + valore;
    }
</script>
</html>
