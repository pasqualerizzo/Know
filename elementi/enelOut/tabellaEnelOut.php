...
$query = "SELECT * FROM `enelOut` inner join aggiuntaEnelOut on enelOut.id=aggiuntaEnelOut.id where mese='$meseSelezionato'";
...
<div class='blueTable' class="pagina">
    <div>
...
<script>
    ...
    function redirigi(sel) {
        ...
        window.location.href = "tabellaEnelOut.php?meseSelezionato=" + data;
    ...
    function scaricaCSV() {
        ...
        window.location.href = "exportTabellaEnelOut.php?meseSelezionato=" + valore;
    }
</script>
</html>
