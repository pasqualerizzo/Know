...
$queryMese = "SELECT dataInizioValidita FROM `enelOutPesiFibra` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `enelOutPesiFibra` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Enel Out:<br>Pesi Fibra</h1>
        </header>
        <div>
    ...
    <script>
        ...
        function redirigi(sel) {
            ...
            window.location.href = "tabellaPesiFibra.php?meseSelezionato=" + data;
        ...
        function aggiungiMese() {
            ...
            window.location.href = "aggiungiMesePesoFibra.php";
        }
        ...
        $(function () {
            $('#pesi td').on('click', function () {
                ...
                window.location.href = 'modificaPesiFibra.php?id=' + id;
            });
        });
    </script>
</html>
