...
$queryMese = "SELECT dataInizioValidita FROM `enelOutPesiComoditi` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `enelOutPesiComoditi` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Enel Out: <br>Pesi Comodity</h1>
