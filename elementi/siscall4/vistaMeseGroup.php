...
$queryMese = "SELECT mese FROM `stringheSiscall4` group by mese";
...
$query = "SELECT user,nomeCompleto,sede,userGroup,mandato,SUM(pause),SUM(wait),SUM(talk),SUM(dispo),SUM(numero),Sum(dead) FROM `stringheSiscall4`where mese='$meseSelezionato' group by user";
