...
$queryMese = "SELECT dataInizioValidita FROM `enelPesiSanata` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `enelPesiSanata` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Enel:<br>Pesi Sanata</h1>
        </header>
        <div>
