...
$queryMese = "SELECT dataInizioValidita FROM `enelPesiMetodoPagamento` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `enelPesiMetodoPagamento` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Enel:<br>Pesi Pagamento</h1>
        </header>
        <div>
