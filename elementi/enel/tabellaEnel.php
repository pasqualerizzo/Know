...
$query = "SELECT * FROM `enel` inner join aggiuntaEnel on enel.id=aggiuntaEnel.id where mese='$meseSelezionato'";
...
<html>
    ...
    <script>
        ...
        function scaricaCSV() {
            ...
            console.log(valore);
            window.location.href = "exportTabellaEnel.php?meseSelezionato=" + valore;
        }
    </script>
</html>
