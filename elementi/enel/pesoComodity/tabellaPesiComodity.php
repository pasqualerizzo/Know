...
$queryMese = "SELECT dataInizioValidita FROM `enelPesiComoditi` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `enelPesiComoditi` where dataInizioValidita='$meseSelezionato' order by tipoAcquisizione, tipoCampagna,valore";
...
<html>
    <head>
        <title>Metrics: Enel Group</title>
    ...
    <body>
        <header>
            <h1 class="titolo">Enel:<br>Pesi Comodity</h1>
