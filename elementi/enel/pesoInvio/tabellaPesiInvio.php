...
$queryMese = "SELECT dataInizioValidita FROM `enelPesiInvio` GROUP by dataInizioValidita ORDER by dataInizioValidita DESC";
...
$query = "SELECT * FROM `enelPesiInvio` where dataInizioValidita='$meseSelezionato'";
...
<html>
    ...
    <body>
        <header>
            <h1 class="titolo">Enel:<br>Pesi Invio</h1>
        </header>
        <div>
