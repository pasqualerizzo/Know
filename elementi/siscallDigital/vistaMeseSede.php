...
$query = "SELECT sede,mandato,SUM(pause),SUM(wait),SUM(talk),SUM(dispo),SUM(numero),Sum(dead) FROM `stringheSiscallDigital`where mese='$meseSelezionato' group by sede";
...
<script>
    ...
    function scaricaCSV() {
        ...
        window.location.href = "exportVistaMeseSede.php?meseSelezionato=" + valore;
    }
</script>
</html>
