...
$query = "SELECT userGroup,mandato,SUM(pause),SUM(wait),SUM(talk),SUM(dispo),SUM(numero),Sum(dead) FROM `stringheSiscallDigital`where mese='$meseSelezionato' group by userGroup";
