...
$query = "SELECT user,nomeCompleto,sede,userGroup,mandato,SUM(pause),SUM(wait),SUM(talk),SUM(dispo),SUM(numero),Sum(dead) FROM `stringheSiscallGT`where mese='$meseSelezionato' group by user";
